...
(function () {
    ...
    const STORY_DETAILS = {
        ...
        Grus: [
            '두루미자리(Grus)는 남쪽물고기자리와 큰부리새자리 사이의 남쪽 하늘에 놓인 근대 별자리입니다. 라틴어 Grus는 두루미를 뜻하며, 프톨레마이오스가 정리한 고대 48개 별자리에는 포함되지 않았습니다. 따라서 이 별자리에는 고대 그리스에서 이어진 영웅이나 괴물의 신화가 없습니다.',
            '16세기 말 피터르 디르크스존 케이저와 프레데릭 더하우트만은 동인도로 향한 네덜란드 항해에서 유럽에서 보기 어려운 남쪽 별들의 위치를 기록했습니다. 그 관측 자료를 바탕으로 페트뤼스 플란시우스가 새로운 남천 별자리들을 정리했고, 두루미는 1598년 플란시우스와 요도쿠스 혼디우스가 제작한 천구의에 처음 나타났습니다.',
            '이름은 처음부터 한 종류의 새로 고정되어 있지 않았습니다. 더하우트만은 1603년 남천 별목록에서 이 별자리를 네덜란드어 Den Reygher, 곧 왜가리라고 적었습니다. 같은 해 요한 바이어는 《우라노메트리아》에 긴 목의 새를 그리고 라틴어 Grus를 사용했으며, 이 이름이 현대의 두루미자리로 이어졌습니다.',
            '두루미자리로 따로 묶이기 전에는 이 부근의 몇몇 별이 이웃 남쪽물고기자리의 꼬리로 다뤄지기도 했습니다. 20세기 국제천문연맹이 88개 별자리의 이름과 경계를 표준화하면서 Grus도 공식 별자리로 자리 잡았습니다. 이 별자리의 핵심 이야기는 신화가 아니라 항해자의 관측, 천구의 제작, 성도 편찬이 하나의 새 형상을 만들어 낸 과정입니다.'
        ],
        Auriga: [
            '마차부자리(Auriga)는 북쪽 겨울 하늘의 오래된 별자리로, 프톨레마이오스가 기록한 고대 48개 별자리에도 포함되었습니다. 라틴어 Auriga는 마차를 모는 사람을 뜻합니다. 고대의 별그림에서는 인물이 오른손에 고삐를 쥐고, 왼쪽 어깨와 팔에는 암염소와 두 새끼 염소를 안은 독특한 모습으로 나타납니다.',
            '히기누스의 《천문학》 2권 13장은 에라토스테네스를 따라 마차부를 아테네의 에리크토니오스라고 소개합니다. 이 전승에서 그는 인간 가운데 처음으로 네 마리 말을 한 마차에 매었고, 태양신의 사두마차에 견줄 발명을 이룬 인물입니다. 제우스는 그 재능을 기려 에리크토니오스를 별들 사이에 놓았다고 전해집니다.',
            '하지만 마차부의 정체가 에리크토니오스로 확정된 것은 아닙니다. 같은 히기누스의 기록도 사두마차를 발명했다는 아르고스 출신 오르실로코스, 오이노마오스의 마부였던 미르틸로스 등 다른 후보를 함께 전합니다. 마차부자리는 하나의 고정된 인물 전기라기보다 여러 마차 영웅의 이야기가 같은 별무늬에 포개진 별자리입니다.',
            '염소와 새끼 염소의 도상은 마차부 이야기와 나란히 전해진 또 하나의 전통입니다. 아라토스의 《파이노메나》는 마차부의 왼쪽 어깨에 어린 제우스를 먹여 살린 성스러운 암염소가 있고, 손목 가까이에 두 새끼 염소가 빛난다고 묘사합니다. 가장 밝은 별 카펠라와 이 작은 별무리가 남아 있어, 오늘의 마차부자리는 고삐를 쥔 발명가와 제우스의 염소가 한 형상 안에 결합된 모습입니다.'
        ],
        Telescopium: [
            '망원경자리(Telescopium)는 고대 신화가 아니라 18세기 남천 관측에서 태어난 별자리입니다. 프랑스 천문학자 니콜라 루이 드 라카유는 1751년부터 1752년까지 남아프리카 희망봉에서 유럽에서 보기 어려운 남쪽 하늘을 관측했습니다. 그는 약 만 개에 이르는 별의 위치를 기록하며 남천의 빈 영역을 새 별자리들로 정리했습니다. 그 이름 대부분은 영웅이나 동물 대신 계몽시대의 과학기구에서 가져왔습니다.',
            '라카유가 망원경자리 그림에 넣은 것은 현대의 짧은 망원경과 다른 ‘공중망원경’이었습니다. 색수차를 줄이려고 초점거리를 매우 길게 만든 굴절망원경으로, 대물렌즈와 접안렌즈를 긴 거리만큼 벌려 돛대와 줄 같은 구조로 정렬했습니다. 연속된 긴 경통이 없는 경우가 많아 다루기 몹시 까다로웠지만, 당시에는 먼 천체를 더 선명하게 보려는 첨단 관측기구였습니다. 별자리의 원래 형상도 남쪽 하늘을 길게 가로지르는 거대한 망원경으로 그려졌습니다.',
            '이 별자리는 라카유가 1756년에 발표한 남천도에 프랑스어 ‘Le Telescope’로 나타났습니다. 그가 세상을 떠난 뒤 1763년에 출판된 《Coelum Australe Stelliferum》에서는 이름이 라틴어 Telescopium으로 정리되었습니다. 공기펌프자리·현미경자리·시계자리처럼 라카유가 만든 여러 기구 별자리와 함께, 신화의 하늘에 실험과 측정의 시대가 들어온 흔적입니다.',
            '라카유가 처음 그린 망원경자리는 지금보다 훨씬 넓었지만, 19세기 천문학자 프랜시스 베일리와 벤저민 굴드가 별자리 구역을 정리하면서 크게 줄었습니다. 원래 망원경에 속했던 몇몇 밝은 별은 궁수자리·전갈자리·남쪽왕관자리 등 이웃 별자리로 돌아갔습니다. 그래서 오늘날의 망원경자리는 가장 밝은 알파별도 3등급대인 작고 비교적 희미한 남천 별자리입니다. 고대 전승은 없지만, 관측 도구가 우주를 보는 방식을 바꾼 시대를 하늘에 기록하고 있습니다.'
        ],
        'Coma Berenices': [
            '머리털자리(Coma Berenices)는 신화 속 인물이 아니라 실존한 프톨레마이오스 왕조의 왕비 베레니케 2세의 이름을 품은 별자리입니다. 베레니케가 프톨레마이오스 3세와 혼인한 직후 왕은 제3차 시리아 전쟁에 출정했습니다. 왕비는 남편이 무사히 돌아오면 자신의 머리카락을 신들에게 바치겠다고 맹세했다고 전합니다. 이 사건은 기원전 3세기의 궁정시인 칼리마코스가 쓴 「베레니케의 머리카락」에서 별이 된 이야기로 다듬어졌습니다.',
            '전승에 따르면 왕이 돌아온 뒤 베레니케는 머리카락 한 다발을 잘라 제피리온곶의 아프로디테-아르시노에 신전에 바쳤고, 이튿날 봉헌물은 사라졌습니다. 궁정 천문가 코논은 사자의 꼬리 가까이에 흩어진 희미한 별들을 가리키며 머리카락이 하늘로 올라갔다고 설명했습니다. 다만 칼리마코스의 그리스어 원작은 일부만 남았고, 카툴루스의 라틴어 번안과 히기누스 계열 전승 사이에는 봉헌 대상과 세부 장면에 차이가 있습니다. 따라서 사라진 머리카락과 코논의 선언은 역사적 사실로 단정하기보다 당대 왕실을 기념한 궁정 전승으로 보는 편이 정확합니다.',
            '이 별무리는 고대에도 알려졌지만 언제나 독립 별자리였던 것은 아닙니다. 프톨레마이오스는 《알마게스트》에서 이를 사자자리 뒤쪽의 ‘머리카락이라 불리는 흐릿한 무리’로 다루고, 사자자리 바깥의 별들에 포함했습니다. 16세기 천구의와 성도 제작자들이 다시 독립된 형상으로 그렸고, 튀코 브라헤가 1602년 별 목록에 머리털자리를 따로 실으면서 널리 정착했습니다. 그러므로 튀코가 이야기를 새로 만들었다기보다 오래된 별무리를 독립 별자리로 굳힌 셈입니다.',
            '왕비의 머리카락처럼 보이는 핵심 별무리는 오늘날 멜로테 111로 부르는 머리털자리 산개성단입니다. 맨눈으로는 한 점보다 넓게 흩뿌려진 희미한 빛으로 보이고, 쌍안경으로 보면 여러 별이 느슨하게 퍼진 모습이 드러납니다. 머리털자리 방향에는 이 가까운 성단뿐 아니라 훨씬 먼 머리털자리 은하단도 놓여 있어 서로 다른 거리의 ‘별무리’가 겹쳐 보입니다. 현대 88개 별자리 가운데 실존 역사 인물의 이름을 직접 품은 유일한 별자리라는 점도 독특합니다.'
        ],
        Bootes: [
            '목동자리(Boötes)는 프톨레마이오스의 고대 48개 별자리에 들어갈 만큼 오래된 북쪽 별자리지만, 하늘의 인물이 누구인지는 하나로 정해지지 않았습니다. 이름은 그리스어에서 소를 모는 사람, 목동 또는 쟁기꾼으로 풀이됩니다. 기원전 3세기 시인 아라토스는 큰곰자리 뒤를 따라가는 이 인물을 아르크토필락스, 곧 ‘곰지기’라고도 부른다고 적었습니다. 그의 허리 아래에는 유난히 밝은 별 아르크투루스가 빛난다고 묘사했습니다.',
            '히기누스 계열의 한 전승은 목동자리를 제우스와 칼리스토의 아들 아르카스로 봅니다. 곰으로 변한 어머니를 알아보지 못한 성장한 아르카스가 사냥 중 그녀를 뒤쫓다가 출입이 금지된 제우스 리카이오스의 신역에 들어갔습니다. 둘 다 죽을 위기에 놓이자 제우스가 어머니와 아들을 하늘로 옮겼고, 아르카스는 큰곰을 뒤따르는 곰지기가 되었다는 이야기입니다. 다만 다른 고대 전승에서는 아르카스가 작은곰자리와 연결되기도 하므로 목동자리의 유일한 정체로 단정할 수 없습니다.',
            '같은 고대 천문 신화집에는 아티카의 이카리오스를 목동자리로 보는 별개의 이야기도 실려 있습니다. 디오니소스에게 포도주 만드는 법을 배운 이카리오스는 포도주 가죽부대를 수레에 싣고 사람들에게 나누어 주었습니다. 처음 술을 마신 목동들이 쓰러지자 동료들은 독살당한 것으로 오해해 이카리오스를 죽였습니다. 이 전승에서 딸 에리고네와 개 마에라의 비극은 처녀자리와 개의 별로 이어지며, 목동자리는 포도주를 실은 수레를 끌던 이카리오스와 연결됩니다.',
            '또 다른 판본의 주인공 필로멜로스는 데메테르와 이아시온의 아들로, 부유한 형제 플루토스에게 도움을 받지 못하자 남은 재산으로 소 두 마리를 사 수레를 만들고 밭을 갈았습니다. 어머니 데메테르는 그의 발명과 노동을 기려 별들 사이에서 밭 가는 모습으로 나타냈다고 전합니다. 아르카스·이카리오스·필로멜로스는 서로 대체되는 설명이지 한 사람의 연속된 생애가 아닙니다. 실제 하늘에서는 북두칠성 손잡이의 곡선을 따라가면 ‘곰을 지키는 자’라는 뜻의 아르크투루스를 쉽게 찾을 수 있습니다.'
        ],
        Pisces: [
            '물고기자리(Pisces)는 황도 위에 놓인 오래된 별자리입니다. 후기 바빌로니아의 천문·점성 기록에서 오늘날 이 영역은 ‘꼬리들’ 또는 ‘밭’이라는 이름으로 나타납니다. 이것이 곧바로 현재의 두 물고기 그림과 완전히 같았다고 단정할 수는 없지만, 물고기자리의 뿌리가 그리스보다 오래된 메소포타미아 별 전통과 이어진다는 점을 보여 줍니다. 기원전 3세기 시인 아라토스는 이미 한 물고기가 다른 물고기보다 높이 놓이고, 양쪽 꼬리에서 뻗은 사슬이 하나의 매듭에서 만난다고 묘사했습니다.',
            '통상 히기누스에게 돌리는 《아스트로노미카》에는 디오그네토스 에리트라이오스의 이야기라며 한 전승이 실려 있습니다. 아프로디테와 아들 에로스가 시리아의 유프라테스강에 이르렀을 때 괴물 튀폰이 갑자기 나타났고, 두 신은 강물에 뛰어들어 물고기로 모습을 바꾸어 위험을 피했다는 내용입니다. 이 판본에서 별자리의 두 물고기는 어머니와 아들이 변신한 모습이며, 서로를 구해 준 별도의 물고기가 아닙니다.',
            '오비디우스의 《달력》은 같은 이야기를 다르게 전합니다. 튀폰을 피해 유프라테스강에 온 아프로디테와 어린 에로스가 물에 뛰어들자 두 물고기가 그들을 등에 받아 안전하게 옮겼고, 그 공로로 별이 되었다고 합니다. 따라서 ‘두 신이 물고기로 변했다’는 히기누스 계열과 ‘두 물고기가 신들을 구했다’는 오비디우스 계열은 하나의 장면으로 합치기보다 서로 다른 판본으로 구분하는 편이 정확합니다.',
            '실제 성도에서는 두 물고기의 꼬리에서 뻗은 별줄기가 물고기자리 알파별에서 만납니다. 고유명 알레샤(Alrescha)는 아랍어로 ‘끈’을 뜻하며, 아라토스가 말한 ‘꼬리의 매듭’ 자리에 놓입니다. 알파별이지만 약 3.8등급으로 밝지 않고, 물고기자리 전체도 희미한 별이 많아 어두운 하늘에서 형태를 따라가야 합니다. 현재 춘분점도 세차운동 때문에 이 별자리 안에 놓여 있습니다.'
        ],
        Aquarius: [
            '물병자리(Aquarius)는 그리스 신화보다 오래된 메소포타미아의 물 이미지와 이어집니다. 바빌로니아 별목록에서는 이 하늘의 인물을 GU.LA, 곧 ‘위대한 자’라 불렀고 흔히 물의 신 에아와 연결했습니다. 에아는 수메르의 엔키에 대응하는 신이며, 고대 원통 인장에는 그의 어깨에서 물고기가 헤엄치는 물줄기가 흘러나오는 모습도 남아 있습니다. 다만 개별 유물이 곧 물병자리 그림 자체라는 뜻은 아니며, 별자리와 물의 신을 잇는 더 오래된 도상적 배경으로 보는 편이 안전합니다.',
            '그리스·로마 천문 신화에서 가장 널리 알려진 주인공은 트로이 왕가의 소년 가니메데스입니다. 《아스트로노미카》는 제우스가 그의 아름다움 때문에 부모에게서 데려와 신들의 술을 따르는 시종으로 삼았다고 전하며, 그래서 하늘의 인물이 항아리에서 물을 붓는 모습으로 그려졌다고 설명합니다. 가니메데스를 데려간 독수리는 이웃한 독수리자리와도 연결되지만, 제우스가 직접 독수리로 변했다는 판본과 독수리를 보냈다는 판본은 서로 다릅니다.',
            '물병자리의 정체는 가니메데스 한 사람으로 고정되지 않았습니다. 히기누스가 인용한 헤게시어나크스는 대홍수가 그의 시대에 일어났다는 이유로 물을 붓는 인물을 데우칼리온이라고 했습니다. 에우불로스는 포도주가 알려지기 전 신들에게 물을 바쳤던 아테네의 옛 왕 케크롭스라고 해석했습니다. 이들은 가니메데스 이야기의 앞뒤 장면이 아니라, 같은 별그림을 설명하려 한 경쟁하는 고대 해석들입니다.',
            '물병자리는 프톨레마이오스가 정리한 고대 48개 별자리 가운데 하나이며 현대 황도 별자리로도 남아 있습니다. 성도에서는 항아리의 Y자형 별무리에서 긴 물줄기가 아래로 흘러 남쪽물고기자리의 입, 포말하우트 쪽으로 이어집니다. 가장 밝은 별 사달수드도 약 2.9등급이라 전체 윤곽은 두드러지지 않지만, 주변의 물고기자리·고래자리·에리다누스자리와 함께 고대 성도에서 ‘물의 영역’을 이룹니다.'
        ],
        Hydra: [
            '바다뱀자리(Hydra)는 프톨레마이오스의 고대 48개 별자리부터 이어진 크고 오래된 별자리입니다. 그 뿌리를 바빌로니아의 거대한 뱀 또는 무슈후슈 도상에서 찾는 연구가 있지만, 전달 과정을 하나로 확정하기는 어렵습니다. 아라토스는 이미 바다뱀의 머리가 게자리 아래에, 몸통이 사자자리 아래에, 꼬리가 센타우루스자리 위에 길게 뻗고 그 등에는 컵자리와 까마귀자리가 놓인다고 묘사했습니다. 고대 성도의 바다뱀은 여러 머리보다 한 머리를 가진 긴 물뱀 모습입니다.',
            '오비디우스의 《달력》은 이 세 별자리를 한 이야기로 묶습니다. 아폴론은 제우스에게 제사를 올리려 하며 자신이 기르던 까마귀에게 잔을 주고 샘의 깨끗한 물을 길어 오라고 했습니다. 까마귀는 길에서 아직 익지 않은 무화과를 발견하자 명령을 잊고 나무 곁에서 열매가 익기를 기다렸고, 마침내 배불리 먹은 뒤에야 늦은 심부름을 떠올렸습니다.',
            '오비디우스 판본에서 까마귀는 늦은 까닭을 숨기려고 물뱀 한 마리를 붙잡아 돌아와 뱀이 물길을 막았다고 거짓말합니다. 아폴론은 거짓을 알아차리고 까마귀·잔·물뱀을 함께 하늘에 놓았습니다. 히기누스의 《아스트로노미카》는 세 별자리의 배치를 조금 다르게 설명해, 물뱀이 잔 아래에서 목마른 까마귀의 접근을 가로막는 벌의 장면을 강조합니다. 두 고전 판본의 세부는 완전히 같지 않습니다.',
            '바다뱀자리를 헤라클레스가 쓰러뜨린 머리 여럿의 레르네 히드라로 보는 전승도 널리 알려져 있지만, 까마귀·컵과 함께 놓인 한 머리의 물뱀 해석과 구분해 소개할 필요가 있습니다. 현대 경계로는 약 1,303제곱도의 하늘을 차지해 88개 별자리 중 가장 넓고, 머리에서 꼬리까지도 하늘의 4분의 1가량을 뻗습니다. 가장 밝은 주황색 별 알파드는 주변에 밝은 별이 드물어 아랍어로 ‘외로운 자’라는 뜻의 이름을 얻었습니다. 남쪽물뱀자리(Hydrus)는 이 별자리와 별개의 근대 남천 별자리입니다.'
        ],
        Scutum: [
            '방패자리(Scutum)는 고대 영웅의 방패가 아니라 17세기의 역사적 사건을 기념해 만든 근대 별자리입니다. 단치히의 천문학자 요하네스 헤벨리우스는 1684년 새 별자리를 Scutum Sobiescianum, 곧 ‘소비에스키의 방패’라는 이름으로 발표했습니다.',
            '이 이름은 1683년 빈을 포위한 오스만군에 맞서 연합 구원군을 이끈 폴란드 왕 얀 3세 소비에스키를 기렸습니다. 헤벨리우스의 별그림은 왕의 방패를 하늘에 세운 역사적 기념물이었으며, 그 성도는 1690년 헤벨리우스가 세상을 떠난 뒤 출판되어 널리 알려졌습니다.',
            '긴 이름 Scutum Sobiescianum은 후대에 Scutum으로 줄었고, 국제천문연맹의 공식 약자는 Sct입니다. 따라서 이 별자리에 고대 그리스 신화나 아테나의 방패 이야기를 덧붙이기보다, 만들어진 시대와 명명 목적을 구분해 보는 편이 정확합니다.',
            '방패자리는 은하수의 별이 빽빽한 방향에 놓여 있습니다. 그 안의 M11은 수많은 별이 조밀하게 모인 산개성단으로, 밝은 별들이 철새의 V자 대형을 떠올리게 해 ‘야생오리성단’이라는 이름을 얻었습니다. 신화 대신 역사와 실제 별무리가 함께 담긴 작은 별자리입니다.'
        ],
        Cygnus: [
            '백조자리(Cygnus)는 프톨레마이오스의 고대 48개 별자리 가운데 하나입니다. 고대 그리스에서는 이 별무리를 일반적인 ‘새’로도 불렀고, 로마 시대와 후대 성도에서는 백조라는 이름이 자리 잡았습니다. 따라서 처음부터 한 신화의 주인공만을 나타냈다고 단정하기는 어렵습니다.',
            '가장 널리 알려진 해석은 제우스가 백조의 모습으로 스파르타 왕비 레다에게 다가갔다는 전승입니다. 히기누스는 제우스가 독수리에게 쫓기는 백조로 변해 네메시스에게 접근하고, 네메시스가 낳은 알이 레다에게 전해졌다는 다른 판본도 함께 기록합니다. 두 이야기는 비슷한 인물과 상징을 쓰지만 세부가 다른 대안 전승입니다.',
            '백조를 파에톤의 친구 퀴크노스와 연결하는 이야기도 있습니다. 오비디우스의 《변신 이야기》에서 퀴크노스는 추락해 죽은 파에톤을 애도하며 강가에서 유해를 찾다가 백조로 변합니다. 음악가 오르페우스와 백조를 잇는 설명도 별도로 전해지므로, 레다·네메시스·퀴크노스·오르페우스를 한 인물의 연속된 생애처럼 합치지 않아야 합니다.',
            '실제 하늘에서 데네브는 백조의 꼬리에 놓이며 베가·알타이르와 여름철 대삼각형을 이룹니다. 백조의 몸과 날개를 잇는 밝은 별들은 ‘북십자’라는 별무리와 겹치고, 별자리 전체가 은하수를 따라 놓여 성운과 성단이 풍부합니다. 여러 전승이 겹친 백조는 오늘날 여름 하늘의 뚜렷한 길잡이이기도 합니다.'
        ],
        Serpens: [
            '뱀자리(Serpens)는 프톨레마이오스의 고대 48개 별자리부터 이어진 오래된 별자리이며, 라틴어 이름은 ‘뱀’을 뜻합니다. 전통 성도에서는 뱀주인자리의 인물이 두 손으로 붙잡은 한 마리의 긴 뱀으로 그려집니다.',
            '현대 경계에서 뱀자리는 서쪽의 뱀머리 Serpens Caput과 동쪽의 뱀꼬리 Serpens Cauda로 갈리고, 그 사이를 뱀주인자리가 차지합니다. 둘은 별개의 별자리가 아니라 공식 약자 Ser를 함께 쓰는 하나의 별자리이며, 88개 별자리 가운데 서로 떨어진 두 구역으로 나뉜 유일한 경우입니다.',
            '히기누스가 전한 한 판본에서 아스클레피오스는 글라우코스를 되살릴 방법을 고민하다 뱀 한 마리를 죽입니다. 다른 뱀이 약초를 물어 와 죽은 뱀을 살리는 모습을 본 그는 같은 약초를 사용해 글라우코스를 되살렸고, 이 이야기가 뱀과 치유를 잇는 설명 가운데 하나가 되었습니다.',
            '뱀머리 쪽에는 오래된 구상성단 M5가 있고, 뱀꼬리 쪽에는 별이 태어나는 독수리성운 M16이 있습니다. 하나의 뱀이 둘로 갈린 별자리 안에 늙은 별의 거대한 무리와 새 별의 탄생지가 함께 놓인 셈입니다. 뱀자리와 뱀주인자리는 그림으로 연결되지만 현대 체계에서는 서로 다른 두 별자리입니다.'
        ],
        Ophiuchus: [
            '뱀주인자리(Ophiuchus)는 프톨레마이오스의 고대 48개 별자리 가운데 하나이며, 이름은 그리스어 계통으로 ‘뱀을 든 사람’을 뜻합니다. 전통 성도에서는 전갈자리 위에 서서 뱀자리의 긴 몸을 양손으로 붙든 큰 인물로 그려집니다.',
            '가장 널리 알려진 정체는 아폴론의 아들인 치유자 아스클레피오스입니다. 그는 켄타우로스 케이론에게 의술을 배워 병자를 고쳤고, 마침내 죽은 사람까지 되살릴 수 있었다고 전합니다. 뱀자리의 약초 이야기는 그가 생명을 회복시키는 지식을 얻은 과정을 설명합니다.',
            '아스클레피오스가 되살린 사람이 히폴리토스인지 글라우코스인지 등은 고대 판본마다 다릅니다. 제우스는 생사의 질서를 넘은 그에게 번개를 내렸고, 별자리 전승은 뛰어난 치유자를 뱀을 든 모습으로 하늘에 남겼다고 설명합니다. 이 이야기는 죽음과 치유를 둘러싼 여러 판본을 하나로 단정하지 않을 때 더 분명해집니다.',
            '히기누스는 카르나본·헤라클레스·트리오파스·포르바스 같은 다른 정체도 함께 기록하므로 아스클레피오스만이 유일한 해석은 아닙니다. 태양의 길인 황도가 공식 경계 안을 지나 ‘황도를 지나는 13번째 별자리’라 부르기도 하지만, 이는 점성술의 황도 12궁에 새 기호가 추가됐다는 뜻은 아닙니다.'
        ],
        'Corona Borealis': [
            '북쪽왕관자리(Corona Borealis)는 프톨레마이오스의 고대 48개 별자리부터 이어진 북쪽 하늘의 왕관입니다. 남쪽왕관자리와 구별하는 라틴어 이름은 ‘북쪽의 왕관’을 뜻하며, 공식 약자는 CrB입니다.',
            '대표 전승의 주인공 아리아드네는 크레타의 미궁에서 테세우스가 길을 찾아 나오도록 돕고 함께 섬을 떠납니다. 그러나 낙소스에서 홀로 남게 된 까닭은 테세우스의 배신, 디오니소스의 명령, 폭풍 등 판본마다 달라 하나로 단정할 수 없습니다.',
            '히기누스의 한 판본에서는 아리아드네와 디오니소스의 혼인 때 아프로디테와 계절의 여신들이 관을 선물합니다. 다른 판본은 디오니소스가 직접 주었다거나 테세우스가 바다의 여신들에게 받아 아리아드네에게 주었다고 전합니다. 디오니소스가 관을 별들 사이에 놓았다는 결말은 널리 공유되지만, 관의 전달 경로는 서로 다릅니다.',
            '실제 별들은 완전한 원이 아니라 작은 반원형 호를 이룹니다. 가장 밝은 별 알페카는 ‘부서진 고리의 밝은 별’이라는 뜻에서 온 이름으로, 젬마라고도 불렸습니다. 여러 보석이 이어진 관처럼 보이는 단순한 윤곽 덕분에 봄과 초여름 하늘에서 비교적 쉽게 알아볼 수 있습니다.'
        ],
        Phoenix: [
            '불사조자리(Phoenix)는 프톨레마이오스의 고대 48개 별자리가 아니라 대항해시대의 남천 관측으로 만들어진 근대 별자리입니다. 여기서 불사조는 동아시아의 봉황과 동일한 새라기보다, 긴 삶과 죽음 뒤의 재생을 상징한 지중해권의 phoenix 전승을 가리킵니다.',
            '페트뤼스 플란시우스는 피터르 디르크스존 케이저와 프레데릭 더하우트만의 남천 관측을 바탕으로 1598년 천구의에 불사조를 그렸습니다. 요한 바이어가 1603년 《우라노메트리아》에 이를 수록하고, 같은 해 더하우트만의 별 목록에도 불사조라는 이름이 실리면서 널리 알려졌습니다.',
            '헤로도토스는 자신이 이 새를 그림으로만 보았다고 선을 긋고, 헬리오폴리스 사람들이 불사조가 오백 년마다 온다고 말했다고 기록합니다. 그 판본의 새는 붉고 금빛이며, 몰약으로 만든 덩어리 안에 아버지의 유해를 넣어 태양 신전으로 옮깁니다. 자신을 불태우고 재에서 되살아나는 장면은 헤로도토스의 설명에는 없습니다.',
            '불과 재, 죽음과 재생의 이미지는 후대 그리스·로마와 중세 전승에서 더욱 강해졌으며 수명과 죽는 방식도 판본마다 다릅니다. 실제 불사조자리는 비교적 희미한 남쪽 별자리이고, 가장 밝은 알파별의 공식 이름은 안카입니다. 고대 전설의 새를 근대 항해자들이 새로 정리한 별들에 입힌 사례입니다.'
        ],
        Columba: [
            '비둘기자리(Columba)는 라틴어로 그대로 ‘비둘기’를 뜻하는 작은 남천 별자리입니다. 프톨레마이오스의 고대 48개에는 포함되지 않았고, 해당 별들은 큰개자리 아래쪽의 미정형별로 남아 있었습니다.',
            '플란시우스는 1592년 대형 세계지도 가장자리의 작은 천구도에서 이 별들을 독립시켜 Columba Noachi, 곧 ‘노아의 비둘기’라 불렀습니다. 바이어의 1603년 《우라노메트리아》와 같은 해 더하우트만의 ‘올리브 가지를 든 비둘기’ 목록이 이 형상을 널리 퍼뜨렸습니다.',
            '《창세기》에서 첫 비둘기는 발붙일 곳을 찾지 못해 방주로 돌아옵니다. 일주일 뒤 다시 날아간 비둘기는 저녁에 갓 딴 올리브 잎을 물고 돌아와 물이 줄었음을 알렸고, 다시 일주일이 지나 세 번째로 보낸 비둘기는 돌아오지 않았습니다.',
            '《아르고나우티카》에도 아르고호가 충돌암 사이로 들어가기 전에 비둘기를 먼저 날려 보내는 별도의 전승이 있습니다. 비둘기자리가 옛 아르고자리 가까이에 있어 후대에 두 이야기를 연결하기도 했지만, 플란시우스가 남긴 이름은 노아의 비둘기를 명시합니다. 창안 근거와 닮은 후대 연상을 구분할 필요가 있습니다.'
        ],
        'Canes Venatici': [
            '사냥개자리(Canes Venatici)의 라틴어 이름은 복수형 ‘사냥개들’을 뜻합니다. 프톨레마이오스의 고대 별자리가 아니며, 핵심 별들은 큰곰자리 아래의 미정형별로 기록되어 있었습니다.',
            '목동자리 곁에 개가 등장한 데에는 중세 번역의 혼선이 영향을 주었다는 설명이 있습니다. 갈고리 지팡이를 가리킨 아랍어가 ‘개들’과 비슷하게 옮겨지면서 목동이 개를 데리고 있는 그림이 나타났다는 것입니다. 이는 고대 그리스 신화 속 아르카스에게 제우스가 사냥개를 보냈다는 이야기가 아닙니다.',
            '헤벨리우스는 1687년 이 희미한 별들을 두 사냥개로 묶었고, 1690년 사후 출판된 성도에는 목동이 끈을 쥐고 큰곰을 뒤쫓는 모습으로 그렸습니다. 북쪽 개는 아스테리온, 남쪽 개는 카라였으며, 이 이름과 구도는 근대 성도 제작 과정에서 자리 잡았습니다.',
            '남쪽 개 카라의 목걸이에는 이 별자리에서 가장 밝은 코르 카롤리가 놓입니다. 이름은 ‘찰스의 심장’을 뜻하며 찰스 1세를 기린 표현으로 기록되었습니다. 사냥개자리 안에는 작은 망원경으로도 나선 구조를 관찰할 수 있는 대표적인 소용돌이은하 M51도 있습니다.'
        ],
        Leo: [
            '사자자리(Leo)는 황도 위의 오래된 별자리이며, 프톨레마이오스의 고대 48개에도 포함되었습니다. 그 뿌리는 그리스 신화보다 오래되어, 바빌로니아의 별 목록은 이 영역을 ‘큰 사자’로 기록했습니다. 따라서 네메아의 사자가 별자리 형상의 최초 기원이라고 단정하기보다 오래된 사자 위에 그리스 영웅 전승이 포개졌다고 보는 편이 정확합니다.',
            '그리스 전승에서 사자자리는 헤라클레스의 첫 번째 과업 대상인 네메아의 사자와 연결됩니다. 통상 아폴로도로스의 이름으로 전해지는 《도서관》에서 이 사자는 무기에 상처를 입지 않는 질긴 가죽을 가졌으며, 네메아 일대를 위협했습니다.',
            '헤라클레스가 쏜 화살은 사자의 가죽을 뚫지 못했습니다. 그는 입구가 둘인 동굴의 한쪽을 막고 다른 쪽으로 들어가 사자를 맨손으로 제압했고, 사자의 발톱을 이용해 질긴 가죽을 벗겨 갑옷처럼 걸쳤다고 전합니다. 고대 천문 신화는 이 사자를 하늘의 Leo와 연결하지만, 사자 형상 자체는 그보다 오래되었습니다.',
            '실제 하늘에서는 레굴루스가 사자의 심장 부근을 밝히고 데네볼라는 꼬리를 표시합니다. 머리와 갈기를 이루는 낫 모양 별무리는 거꾸로 된 물음표처럼 보여 봄철 사자자리를 찾는 표지가 됩니다. 가장 오래된 동물 별그림 가운데 하나와 헤라클레스의 과업이 같은 하늘에 겹친 셈입니다.'
        ],
        Lynx: [
            '살쾡이자리(Lynx)는 고대 신화에서 내려온 별자리가 아니라 요하네스 헤벨리우스가 만든 근대 별자리입니다. 큰곰자리와 마차부자리 사이의 넓은 틈에 놓인 희미한 별들을 하나의 긴 고양잇과 동물로 묶었습니다.',
            '헤벨리우스는 1687년 별 목록에 새 별자리를 실었고, 1690년 사후 출판된 성도에 그 모습을 그렸습니다. 별들이 너무 희미해 찾으려면 ‘살쾡이의 눈’이 필요하다는 뜻에서 이름을 붙였다고 전합니다.',
            '그의 별 목록에는 Lynx, sive Tigris, 곧 ‘살쾡이 또는 호랑이’라는 표현이 함께 쓰였지만 후대에는 Lynx가 남았습니다. 이름이 예리한 시력으로 유명한 아르고나우타이 린케우스와 비슷해 연결하는 설명도 있으나, 창안 기록은 고대 영웅보다 동물의 날카로운 눈과 희미한 별을 가리킵니다.',
            '가장 밝은 알파별도 약 3.1등급이고 나머지는 더 어두워, 빛 공해가 적은 밤하늘에서야 굽은 별줄기가 드러납니다. 경계 안의 NGC 2419는 약 30만 광년 떨어진 먼 구상성단으로 ‘은하간 방랑자’라는 별명이 있지만 실제로는 우리은하 외곽 헤일로에 속합니다.'
        ],
        Triangulum: [
            '삼각형자리(Triangulum)는 프톨레마이오스의 고대 48개 별자리 가운데 하나입니다. 밝은 별 셋이 작고 뚜렷한 삼각형을 이루어, 그리스인은 이를 델토톤(Δελτωτόν), 곧 대문자 델타 모양이라 불렀습니다. 화려한 영웅보다 단순한 기하학 도형을 그대로 하늘에 옮긴 드문 고대 별자리입니다.',
            '이 삼각형을 나일강 삼각주와 연결한 설명이 전해지고, 시칠리아섬의 세 모서리를 닮았다고 보는 전승도 있습니다. 로마 시대에는 시칠리아를 뜻하는 시킬리아라는 이름도 쓰였습니다. 이들은 같은 별무늬를 해석한 서로 다른 지리적 연상이며, 하나의 고정된 신화로 합칠 필요는 없습니다.',
            '프톨레마이오스는 2세기 《알마게스트》에서 이 별자리를 독립된 형상으로 기록했습니다. 후대 성도에서는 둘째 삼각형을 덧붙여 Triangulum Minus라 부르기도 했지만 오래 남지 않았고, 오늘날 국제천문연맹의 88개 별자리에는 고대의 Triangulum만 이어집니다.',
            '삼각형자리 안에는 약 273만 광년 떨어진 나선은하 M33이 있습니다. 안드로메다은하와 우리은하에 이어 국부은하군에서 세 번째로 큰 은하이며, 하늘이 매우 어두우면 맨눈으로도 희미하게 볼 수 있습니다. 작은 별 도형 안에 거대한 이웃 은하가 함께 빛나는 별자리입니다.'
        ],
        Cepheus: [
            '세페우스자리(Cepheus)는 프톨레마이오스의 고대 48개 별자리 가운데 하나이며, 그리스 전승의 에티오피아 왕 케페우스를 나타냅니다. 그는 왕비 카시오페이아의 남편이자 안드로메다의 아버지로, 북쪽 하늘에서 두 별자리와 가까이 놓여 있습니다.',
            '카시오페이아가 자신이나 딸의 아름다움을 바다의 님프 네레이데스보다 높이 자랑하자 포세이돈은 나라에 재앙을 내렸습니다. 전승에 따라 홍수 또는 바다 괴물 케토스가 등장하며, 신탁은 재앙을 멈추려면 안드로메다를 제물로 바쳐야 한다고 말합니다.',
            '바위에 묶인 안드로메다는 메두사를 물리치고 돌아오던 페르세우스에게 구출됩니다. 세페우스·카시오페이아·안드로메다·페르세우스·케토스는 오늘날 서로 이웃한 별자리로 남아 한 가족의 위기와 구출 이야기를 넓은 가을 하늘에 펼쳐 놓습니다.',
            '세페우스자리의 델타 세페이는 일정한 주기로 밝기가 변하는 고전적 세페이드 변광성의 대표 별입니다. 같은 종류 별들의 변광 주기와 실제 광도 사이 관계는 우주의 거리를 재는 중요한 기준이 되었고, 세페우스자리는 고대 왕의 이야기와 현대 우주 거리 사다리를 함께 품게 되었습니다.'
        ],
        Centaurus: [
            '센타우루스자리(Centaurus)는 프톨레마이오스의 고대 48개 별자리 가운데 하나이며, 사람의 상반신과 말의 몸을 지닌 켄타우로스를 나타냅니다. 고대 성도에서는 활을 겨눈 궁수자리와 달리 무기를 들지 않고, 두 손으로 이리자리의 짐승을 붙든 채 제단자리 쪽으로 내미는 모습으로 그려졌습니다.',
            '후대에는 현명한 켄타우로스 케이론과 자주 연결되지만, 고대 자료의 정체는 하나로 고정되지 않았습니다. 케이론·폴로스 등 여러 이름이 제시되며, 제물로 바칠 짐승을 제단으로 가져가는 익명의 켄타우로스로 해석되기도 합니다. 따라서 센타우루스자리와 궁수자리를 같은 인물로 단정하지 않는 편이 정확합니다.',
            '지구 자전축이 장기간에 걸쳐 움직이는 세차운동 때문에 이 별자리는 고대보다 북쪽 지역에서 점차 보기 어려워졌습니다. 오늘날 한국에서는 일부만 낮게 보이고, 별자리 전체는 남반구에서 훨씬 잘 관측됩니다. 남십자자리의 별들도 고대에는 센타우루스자리의 일부로 기록되었습니다.',
            '알파 센타우리는 태양에서 약 4.37광년 떨어진 가장 가까운 항성계이며, 그 구성원 프록시마 센타우리는 태양에 가장 가까운 별입니다. 오메가 센타우리는 수백만 개의 별이 모인 거대한 구상성단입니다. 두 천체는 센타우루스자리를 남쪽 하늘의 대표적인 관측 대상으로 만듭니다.'
        ],
        Horologium: [
            '시계자리(Horologium)는 고대 신화가 아니라 18세기 과학기구에서 태어난 남천 별자리입니다. 프랑스 천문학자 니콜라 루이 드 라카유는 1751년부터 1752년까지 남아프리카 희망봉에서 남쪽 하늘을 관측하며 희미한 별들을 새로운 기구 모양으로 정리했습니다.',
            '라카유는 이 별자리를 진자시계의 모습으로 그렸습니다. 진자시계는 크리스티안 하위헌스가 17세기에 실용화해 이전보다 훨씬 정확한 시간 측정을 가능하게 했고, 관측 시각을 기록해 별의 위치를 재는 천문학에도 중요한 도구가 되었습니다.',
            '1756년 남천도에 실린 초기 이름은 ‘진동 시계’를 뜻하는 Horologium Oscillitorium이었고, 뒤에 한 단어인 Horologium으로 줄었습니다. 신이나 영웅의 사건을 나타내기보다 정밀한 시간 측정과 남천 측량의 역사를 기념하는 근대 별자리입니다.',
            '시계자리의 가장 밝은 알파별도 약 3.9등급이라 전체 윤곽은 희미합니다. 그 안의 R 시계자리는 밝기가 크게 달라지는 미라형 변광성으로 알려져 있습니다. 눈에 잘 띄지 않는 별자리지만, 일정하게 흔들리는 진자와 실제로 밝기가 변하는 별이 한 하늘에 함께 놓여 있습니다.'
        ],
        Gemini: [
            '쌍둥이자리(Gemini)는 황도 위의 오래된 별자리이며 프톨레마이오스의 고대 48개에도 포함되었습니다. 가장 밝은 두 별 카스토르와 폴룩스는 그리스 이름 카스토르와 폴리데우케스를 이어받았고, 두 형제는 함께 디오스쿠로이로 불렸습니다.',
            '널리 알려진 판본에서 두 사람은 스파르타 왕비 레다의 아들로 함께 자랐지만 운명은 달랐습니다. 카스토르는 인간 틴다레오스의 아들이라 죽을 수 있었고, 폴리데우케스는 제우스의 아들이라 불멸이었습니다. 계보와 함께 태어난 형제들의 조합은 고대 저자마다 조금씩 다릅니다.',
            '카스토르가 친족 간 싸움에서 죽자 폴리데우케스는 혼자 누리는 불멸을 거부하고 제우스에게 형제와 운명을 나누게 해 달라고 청합니다. 한 전승에서는 두 형제가 하루씩 올림포스와 저승을 오가고, 다른 설명에서는 함께 별들 사이에 놓입니다. 죽음조차 둘을 완전히 갈라놓지 못한 이야기입니다.',
            '실제 카스토르는 맨눈에는 하나로 보이지만 여러 별이 중력으로 묶인 다중성계이고, 폴룩스는 행성을 거느린 주황색 거성입니다. 쌍둥이의 발 부근에는 밝은 산개성단 M35도 있습니다. 신화 속 두 이름과 서로 다른 실제 항성계가 겨울 하늘에서 나란히 빛납니다.'
        ],
        Andromeda: [
            '안드로메다자리(Andromeda)는 프톨레마이오스의 고대 48개 별자리 가운데 하나이며, 에티오피아 왕 세페우스와 왕비 카시오페이아의 딸을 나타냅니다. 북쪽 하늘에서 부모와 페르세우스·페가수스·고래자리 사이에 놓여 한 이야기의 인물들을 이어 줍니다.',
            '카시오페이아가 자신의 아름다움을 바다의 님프보다 높이 자랑하자 포세이돈은 바다 괴물 케토스를 보내 나라를 벌했습니다. 신탁에 따라 안드로메다는 바닷가 바위에 묶여 제물이 되었고, 이 장면이 고대와 후대 미술에서 별자리의 대표 모습으로 남았습니다.',
            '메두사를 물리치고 돌아가던 페르세우스는 안드로메다를 발견하고 그녀를 구합니다. 괴물을 쓰러뜨린 방식과 혼인 과정의 세부는 판본마다 다르지만, 두 사람과 안드로메다의 부모, 케토스가 별자리로 함께 남았다는 결말이 널리 전해집니다.',
            '안드로메다자리의 M31은 약 250만 광년 떨어진 거대한 나선은하이며 우리은하와 가장 가까운 대형 은하입니다. 어두운 밤에는 맨눈으로 희미한 얼룩처럼 보여 인간이 별도의 장비 없이 볼 수 있는 가장 먼 천체 가운데 하나입니다. 묶인 공주의 별줄기 곁에 거대한 이웃 은하가 놓여 있습니다.'
        ],
        Aries: [
            '양자리(Aries)는 황도 위의 매우 오래된 별자리입니다. 메소포타미아의 별 전통에서는 이 영역이 처음부터 오늘날과 같은 숫양만을 뜻하지 않았지만, 그리스 시대에는 황금빛 숫양 이야기와 굳게 연결되었고 프톨레마이오스의 고대 48개에도 포함되었습니다.',
            '그리스 전승에서 프릭소스와 헬레 남매는 계모 이노의 음모로 희생될 위기에 놓입니다. 어머니 네펠레는 두 아이를 구하려 황금 털을 지닌 날개 달린 숫양을 보냈고, 남매는 숫양 등에 올라 바다를 건넜습니다. 헬레는 도중에 바다로 떨어졌고 그 바다는 헬레스폰토스라는 이름을 얻었다고 전합니다.',
            '프릭소스는 콜키스에 도착해 숫양을 제물로 바치고 황금양털을 왕 아이에테스에게 맡겼습니다. 왕은 양털을 신성한 숲에 걸고 잠들지 않는 용에게 지키게 했습니다. 훗날 이아손과 아르고나우타이의 원정은 바로 이 황금양털을 되찾는 것을 목표로 시작됩니다.',
            '가장 밝은 별 하말은 숫양의 머리를 표시합니다. 춘분점은 고대에 양자리 안에 있어 지금도 천구 좌표의 기준을 ‘양자리의 첫 점’이라 부르지만, 세차운동 때문에 실제 춘분점은 현재 물고기자리 쪽으로 옮겨갔습니다. 오래된 황도 전통의 이름이 현대 천문 좌표에 남아 있는 셈입니다.'
        ],
        Eridanus: [
            '에리다누스자리(Eridanus)는 오리온자리의 발치에서 시작해 남쪽 하늘로 길게 굽이치는 고대의 강 별자리입니다. 프톨레마이오스의 고대 48개에 포함되었고, 그리스인은 하늘의 강을 신화적 강 에리다노스와 연결했습니다.',
            '가장 널리 알려진 전승에서 태양신 헬리오스의 아들 파에톤은 아버지의 태양마차를 하루만 몰게 해 달라고 청합니다. 그러나 말들을 제어하지 못해 하늘과 땅을 지나치게 달구거나 얼게 만들었고, 더 큰 재앙을 막으려 한 제우스의 번개를 맞아 추락합니다.',
            '파에톤이 떨어진 강을 에리다노스라 부르면서 하늘의 긴 별줄기와 비극을 연결했습니다. 고대와 후대 저자들은 이 신화의 강을 이탈리아의 포강, 이집트의 나일강 등 서로 다른 실제 강과 동일시하기도 했습니다. 별자리의 강과 지상의 한 장소를 정확히 하나로 고정하기는 어렵습니다.',
            '별자리 남쪽 끝의 아케르나르는 이름 그대로 ‘강의 끝’을 뜻하는 밝은 별입니다. 매우 빠르게 자전해 적도 방향이 부풀고 극 방향이 납작한 모습으로 관측됩니다. 북쪽의 오리온 발치에서 남쪽의 아케르나르까지 이어지는 긴 흐름은 88개 별자리 가운데서도 가장 길게 굽이치는 윤곽을 만듭니다.'
        ],
        Vulpecula: [
            '여우자리(Vulpecula)는 고대 신화가 아니라 17세기 천문학자 요하네스 헤벨리우스가 만든 작은 북쪽 별자리입니다. 그는 독수리자리와 백조자리 사이의 희미한 별들을 묶어 1687년 별 목록에 새 형상을 소개했습니다.',
            '초기 이름은 Vulpecula cum Ansere, 곧 ‘거위를 문 작은 여우’였습니다. 헤벨리우스의 성도에는 여우가 거위를 입에 문 모습으로 그려졌고, 이는 고대 전승의 한 장면이 아니라 빈 하늘을 채우기 위해 만든 근대의 동물 그림이었습니다.',
            '시간이 지나 이름에서 거위가 사라지고 작은 여우를 뜻하는 Vulpecula만 공식 별자리로 남았습니다. 다만 이 별자리에서 가장 밝은 알파별의 고유명 안세르(Anser)가 라틴어 ‘거위’를 뜻해 옛 이름의 흔적을 보존합니다.',
            '여우자리 안의 M27은 1764년 샤를 메시에가 발견한 행성상성운이며, 이 종류의 천체로는 최초로 발견된 사례입니다. 망원경에서는 아령이나 사과를 먹고 남은 심처럼 보여 아령성운이라 불립니다. 희미한 근대 별자리 안에 죽어가는 별이 남긴 밝은 가스 껍질이 펼쳐져 있습니다.'
        ],
        Capricornus: [
            '염소자리(Capricornus)는 물고기 꼬리를 가진 염소, 곧 바다염소를 나타내는 오래된 황도 별자리입니다. 이 형상은 그리스보다 앞선 메소포타미아 전통에서 물과 지혜의 신 에아와 연결되었고, 프톨레마이오스의 고대 48개에도 이어졌습니다.',
            '그리스·로마 시대에는 자연과 목축의 신 판 이야기와 자주 연결됩니다. 괴물 튀폰을 피해 신들이 동물로 변해 달아날 때 판이 물속으로 뛰어들었고, 물에 잠긴 아래쪽은 물고기, 물 밖의 위쪽은 염소가 되었다는 설명입니다. 세부는 고대 저자마다 다르지만 바다염소 형상을 설명하는 대표 전승입니다.',
            '어린 제우스를 돌본 염소 아말테이아와 풍요의 뿔 이야기도 염소자리와 연결되곤 합니다. 그러나 판의 변신과 아말테이아의 양육은 서로 다른 전승이므로 한 사건의 앞뒤 장면처럼 합치지 않는 편이 정확합니다.',
            '별자리의 가장 밝은 별 데네브 알게디는 ‘염소의 꼬리’를 뜻하고, 경계 안에는 구상성단 M30이 있습니다. 남회귀선의 영어 이름 Tropic of Capricorn도 고대 동지점이 이 별자리에 있던 데서 왔지만, 세차운동으로 오늘날 동지의 태양은 궁수자리 방향에 놓입니다.'
        ],
    Orion: [
            '오리온자리(Orion)는 프톨레마이오스의 고대 48개 별자리 가운데 하나이며, 겨울 하늘에서 가장 알아보기 쉬운 별자리로 꼽힙니다. 일직선으로 늘어선 알니타크·알닐람·민타카가 사냥꾼의 허리띠를 이루고, 네 밝은 별이 어깨와 두 발을 표시합니다.',
            '그리스 전승의 오리온은 뛰어난 사냥꾼이지만 탄생과 죽음의 과정은 한 가지로 고정되지 않습니다. 전갈에게 물려 죽었다는 이야기, 아르테미스의 화살에 쓰러졌다는 이야기 등 여러 갈래가 전해지므로, 하나의 판본만을 별자리의 유일한 정답처럼 볼 수는 없습니다.',
            '오리온자리와 전갈자리는 하늘의 반대편에 가까이 놓여 있습니다. 북반구에서 오리온은 겨울 저녁을 대표하고 전갈은 여름 저녁을 대표해, 전갈이 떠오르면 오리온이 물러난다는 신화적 설명과 실제 계절 변화가 자연스럽게 겹칩니다.',
            '붉은 초거성 베텔게우스와 푸른빛의 리겔이 사냥꾼의 몸을 밝힙니다. 허리띠 아래 칼 부분의 오리온대성운 M42는 약 1,300광년 떨어진 거대한 별 탄생지로, 맨눈에도 흐릿한 빛무리로 보입니다. 고대 사냥꾼의 칼 안에서 실제로 새로운 별들이 태어나고 있는 셈입니다.'
        ],
        Monoceros: [
            '외뿔소자리(Monoceros)는 오리온자리와 큰개자리·작은개자리 사이의 희미한 별밭을 차지합니다. 고대 그리스의 48개 별자리에는 없었고, 네덜란드 지도 제작자 페트뤼스 플란시우스가 1612년 천구의에 Monoceros Unicornis라는 이름으로 그려 넣은 근대 별자리입니다.',
            '야코프 바르치는 1624년 성도에서 이 별자리를 Unicornu라는 이름으로 소개해 널리 알렸습니다. 후대에 성서나 고대 동물 전승과 연결하는 설명도 붙었지만, 별자리 자체가 고대 신화에서 전해진 것은 아닙니다. 희미한 빈 영역을 근대 성도가 새로운 형상으로 채운 사례입니다.',
            '가장 밝은 별도 4등급 안팎이라 도시 하늘에서는 외뿔소의 윤곽을 찾기 어렵습니다. 그러나 천구 적도와 겨울 은하수가 지나는 위치 덕분에 별과 가스가 풍부하며, 베타별은 작은 망원경에서 세 별이 모인 아름다운 다중성계로 보입니다.',
            '경계 안에는 붉은 꽃처럼 펼쳐진 장미성운과 크리스마스트리 성단 NGC 2264가 있습니다. 원뿔성운과 변광성들이 모인 이 영역에서는 지금도 별이 만들어집니다. 눈에 띄는 밝은 별은 적지만 망원경으로 보면 거대한 별 탄생지들이 숨어 있는 별자리입니다.'
        ],
        Carina: [
            '용골자리(Carina)는 고대의 거대한 아르고자리(Argo Navis)에서 갈라져 나온 별자리입니다. 아르고자리는 이아손과 아르고나우타이 영웅들이 황금양털을 찾아 항해한 배를 나타냈고, 프톨레마이오스의 고대 48개 가운데 면적이 가장 큰 형상이었습니다.',
            '18세기 천문학자 니콜라 루이 드 라카유는 남천의 별을 정리하면서 아르고호를 용골자리·고물자리·돛자리의 세 구역으로 나누어 목록에 실었습니다. 이 구분이 현대 별자리 체계에 정착했지만, 세 별자리는 하나의 배에서 나온 흔적 때문에 그리스 문자 별 이름을 서로 나누어 가진 독특한 구조를 보입니다.',
            '용골자리의 알파별 카노푸스는 시리우스 다음으로 밝은 밤하늘의 항성입니다. 한국 남부에서는 겨울철 남쪽 지평선 가까이에서 조건이 좋을 때 잠깐 볼 수 있으며, 오랫동안 남쪽 바다를 항해하는 사람들의 중요한 길잡이로 쓰였습니다.',
            '용골성운 NGC 3372는 거대한 별들이 태어나는 남천의 대표적인 별 탄생지입니다. 그 안의 에타 용골은 19세기 대폭발 때 한때 밤하늘에서 매우 밝아졌고, 방출된 가스가 호문쿨루스성운을 만들었습니다. 신화 속 배의 뼈대 안에 실제 별의 탄생과 격렬한 죽음의 전조가 함께 담겨 있습니다.'
        ],
        Draco: [
            '용자리(Draco)는 프톨레마이오스의 고대 48개 별자리 가운데 하나이며, 큰곰자리와 작은곰자리 사이에서 천구 북극 둘레를 길게 감쌉니다. 북반구 중위도에서는 지평선 아래로 완전히 지지 않는 주극 별자리여서 계절마다 북쪽 하늘에서 볼 수 있습니다.',
            '용의 정체에는 여러 전승이 있지만, 널리 알려진 이야기는 헤라의 정원에서 황금사과를 지키던 라돈입니다. 헤라클레스가 열한 번째 과업으로 사과를 가져온 뒤 라돈이 별들 사이에 놓였다고 전합니다. 다른 고대 전승에서는 아테나가 거인족의 용을 하늘로 던졌다고도 합니다.',
            '알파별 투반은 지구 자전축의 세차운동 때문에 약 4천 년 전 북극성 역할을 했습니다. 오늘날에는 폴라리스가 북극 가까이에 있지만, 북극의 방향이 하늘에서 천천히 원을 그리므로 시대마다 북극에 가장 가까운 별이 달라집니다.',
            '가장 밝은 별 엘타닌은 용의 머리 부근을 표시하고, 경계 안에는 복잡한 겹껍질을 지닌 고양이눈성운 NGC 6543이 있습니다. 망원경 사진에서 청록색 눈동자처럼 보이는 이 행성상성운은 죽어가는 별이 바깥층을 우주로 내보낸 흔적입니다.'
        ],
        Sextans: [
            '육분의자리(Sextans)는 고대 신화가 아니라 천문학자 요하네스 헤벨리우스의 관측기구에서 태어난 별자리입니다. 헤벨리우스는 망원경 조준장치가 널리 쓰이기 전의 대형 개방식 육분의로 두 별 사이의 각도를 정밀하게 재어 별의 위치를 기록했습니다.',
            '1679년 단치히의 화재가 그의 집과 관측소를 덮치면서 책과 관측기구 대부분이 불탔습니다. 헤벨리우스는 잃어버린 육분의를 기억하기 위해 사자자리와 바다뱀자리 사이의 희미한 별들을 기구 모양으로 묶었다고 전합니다.',
            '그는 1687년 별 목록에 Sextans Uraniae, 곧 ‘우라니아의 육분의’를 실었고, 사후 출판된 1690년 성도에도 그 모습을 남겼습니다. 우라니아는 천문을 관장하는 뮤즈이며, 이 별자리는 영웅보다 관측과 측량의 역사를 기념합니다.',
            '가장 밝은 알파별도 약 4.5등급이라 별자리 자체는 매우 희미합니다. 대신 경계 안에는 옆으로 누운 렌즈처럼 보이는 스핀들은하 NGC 3115와 가까운 왜소은하들이 있습니다. 불길 속에서 사라진 금속 기구가 어두운 별밭의 이름으로 살아남은 셈입니다.'
        ],
        Lupus: [
            '이리자리(Lupus)는 프톨레마이오스의 고대 48개 별자리 가운데 하나지만, 처음부터 늑대를 뜻한 것은 아닙니다. 고대 그리스에서는 센타우루스자리가 붙들고 있는 정체가 분명하지 않은 짐승을 테리온, 곧 ‘야수’라고 불렀습니다.',
            '고대 성도에서 센타우루스는 이 짐승을 제단자리 쪽으로 내미는 모습으로 그려졌습니다. 제물로 바치려는 장면으로 해석되기도 하고, 포도주 부대라는 다른 설명도 있어 하나의 독립된 늑대 신화로 단정하기 어렵습니다.',
            '그리스어의 일반적인 야수가 라틴 성도에서 Lupus, 곧 늑대로 번역되면서 오늘날의 이리자리 형상이 굳어졌습니다. 그래서 센타우루스자리·이리자리·제단자리는 하늘에서 서로 맞닿아 한 장면을 이루지만, 각 별자리의 후대 이름과 고대 도상을 구분해서 보는 편이 정확합니다.',
            '이리자리에는 1006년 세계 여러 지역의 기록에 등장한 초신성 SN 1006의 잔해가 있습니다. 당시 새 별은 금성보다 밝아 기록된 역사상 가장 밝은 항성 폭발로 여겨집니다. 오늘날에는 폭발한 백색왜성의 물질이 퍼져 나가는 거대한 고리 모양 잔해를 X선과 가시광선으로 관측합니다.'
        ],
        Indus: [
            '인디언자리(Indus)는 고대 별자리가 아니라 대항해시대의 남천 관측에서 태어났습니다. 피터르 디르크스존 케이저와 프레데릭 더하우트만이 1590년대 동인도 항로에서 기록한 별들을 바탕으로, 페트뤼스 플란시우스가 1598년 천구의에 만든 열두 남천 별자리 가운데 하나입니다.',
            '요한 바이어는 1603년 《우라노메트리아》에 이 별자리를 실어 널리 알렸습니다. 초기 성도는 활이나 창을 든 비유럽권 인물을 그렸지만, 그 인물이 아메리카·마다가스카르·동인도 가운데 정확히 어느 지역 사람을 뜻하는지는 분명하지 않습니다.',
            '따라서 옛 그림은 실제 한 민족의 정확한 기록이라기보다, 16세기 유럽인이 낯선 지역의 사람을 일반화해 바라본 시대적 도상으로 이해해야 합니다. 오늘날 별자리 이름은 국제적으로 정해진 천구의 경계를 가리키며, 옛 인물 그림을 사실적인 민족 표상으로 받아들일 필요는 없습니다.',
            '가장 밝은 알파 인디는 3등급대의 주황색 거성이고, 엡실론 인디는 약 11.9광년 떨어진 가까운 항성계입니다. 한국에서는 전체를 보기 어려운 깊은 남쪽 하늘에 놓여 있습니다. 인디언자리는 항해 관측의 성과와 당시 유럽 성도의 한계를 함께 보여 주는 별자리입니다.'
        ],
        'Canis Minor': [
            '작은개자리(Canis Minor)는 프톨레마이오스의 고대 48개 별자리 가운데 하나이며, 밝은 프로키온과 고메이사 두 별이 단순한 몸체를 이룹니다. 큰개자리와 함께 오리온을 따르는 사냥개로 그려지지만, 두 개자리 사이에는 외뿔소자리가 놓여 있습니다.',
            '프로키온이라는 이름은 그리스어로 ‘개보다 먼저’를 뜻합니다. 북반구 중위도에서 프로키온이 큰개자리의 시리우스, 곧 개의 별보다 먼저 떠오르는 모습을 가리킵니다. 별의 이름 자체가 계절 하늘에서 두 별이 올라오는 순서를 기록한 셈입니다.',
            '그리스 전승에서 작은개의 정체는 하나로 고정되지 않습니다. 오리온을 따르는 작은 사냥개라는 설명과, 포도주를 전한 이카리오스의 죽음을 딸 에리고네에게 알린 충직한 개 마이라라는 이야기가 따로 전해집니다. 두 전승을 하나의 사건처럼 합칠 필요는 없습니다.',
            '프로키온은 약 11.5광년 떨어진 가까운 쌍성계로, 밝은 주성과 희미한 백색왜성 동반성이 서로 돕니다. 겨울 하늘에서는 프로키온·베텔게우스·시리우스가 큰 삼각형을 이루어 겨울철 대삼각형이라 불립니다. 작은 별자리의 한 별이 넓은 겨울 하늘을 찾는 기준이 됩니다.'
        ],
        'Ursa Minor': [
            '작은곰자리(Ursa Minor)는 프톨레마이오스의 고대 48개 별자리 가운데 하나입니다. 꼬리와 몸통의 일곱 별은 작은 국자라고 부르는 별무리를 이루지만, 작은 국자는 별자리 전체가 아니라 그 안에서 눈에 띄는 일부 별의 배열입니다.',
            '고대에는 이 별들이 페니키아인의 곰 또는 페니키아인의 별로 불리며 항해의 길잡이로 쓰였다고 전합니다. 큰곰자리보다 천구 북극에 가까워 북쪽 방향을 더 정밀하게 가리켰기 때문입니다. 그리스 전승에서는 탈레스가 이 항해 지식을 소개했다는 설명도 남아 있습니다.',
            '작은곰의 정체는 판본마다 다릅니다. 큰곰 칼리스토의 아들 아르카스라고도 하고, 어린 제우스를 숨겨 키운 님프 가운데 하나라고도 하며, 그 님프의 이름을 키노수라로 전하는 이야기도 있습니다. 하나의 인물만이 유일한 정답은 아닙니다.',
            '꼬리 끝의 폴라리스는 현재 천구 북극에서 약 1도 안에 놓여 북극성 역할을 합니다. 그러나 지구 자전축은 약 2만6천 년 주기로 방향이 바뀌므로 고대에는 용자리의 투반이, 먼 미래에는 거문고자리의 베가가 북극 가까이 옵니다. 북극성은 영원히 같은 별이 아닙니다.'
        ],
        'Leo Minor': [
            '작은사자자리(Leo Minor)는 큰곰자리와 사자자리 사이의 희미한 북쪽 하늘에 놓여 있습니다. 고대 천문가 프톨레마이오스는 이 영역의 별들을 독립된 형상으로 묶지 않고, 사자자리 주변의 미정형별로 분류했습니다.',
            '17세기 천문학자 요하네스 헤벨리우스는 비어 있던 영역의 별들을 모아 작은 사자의 모습을 만들었습니다. 1687년 별 목록에 소개하고 사후 출판된 1690년 성도에 그려 넣었으며, 큰 사자와 큰곰 사이의 동물 배치에 어울리도록 이름을 붙였습니다.',
            '작은사자자리는 고대 신화에서 전해진 사자 새끼가 아니라 근대 성도 제작 과정에서 태어난 별자리입니다. 네메아의 사자나 헤라클레스 이야기와 연결할 근거가 없으며, 희미한 별을 빠짐없이 분류하려 했던 천문 지도의 역사를 보여 줍니다.',
            '가장 밝은 별은 46 LMi, 고유명 프라이키푸아로 약 3.8등급입니다. 그러나 이 별에는 알파라는 바이어 문자가 붙지 않았고, 작은사자자리에는 베타별만 있습니다. 후대의 문자 지정 과정에서 생긴 독특한 빈자리까지도 이 근대 별자리의 역사에 남아 있습니다.'
        ],
        Scorpius: [
            '전갈자리(Scorpius)는 프톨레마이오스의 고대 48개 별자리이자 황도 별자리입니다. 굽은 꼬리까지 이어지는 밝은 별들이 커다란 S자를 이루어 여름철 남쪽 하늘에서 실제 전갈의 윤곽을 비교적 쉽게 알아볼 수 있습니다.',
            '그리스 전승에서는 사냥꾼 오리온을 죽인 전갈로 널리 알려졌지만, 전갈을 보낸 존재와 오리온이 죽은 까닭은 판본마다 다릅니다. 가이아가 오리온의 오만을 벌했다는 이야기와 아르테미스 또는 아폴론이 얽힌 이야기를 하나의 고정된 줄거리로 합칠 필요는 없습니다.',
            '전갈자리와 오리온자리는 하늘에서 서로 반대편에 가까이 놓입니다. 북반구에서 전갈은 여름 저녁, 오리온은 겨울 저녁을 대표하므로 전갈이 떠오르면 오리온이 물러난다는 신화적 설명이 실제 계절 변화와 겹칩니다.',
            '심장 부분의 안타레스는 붉은 초거성이며 이름은 그리스어로 ‘아레스, 곧 화성의 맞수’를 뜻합니다. 꼬리 가까이에는 나비 모양으로 보이는 산개성단 M6와 맨눈으로도 흐릿하게 보이는 큰 산개성단 M7이 은하수 별밭 속에 놓여 있습니다.'
        ],
        Ara: [
            '제단자리(Ara)는 전갈자리 꼬리 남쪽의 은하수에 놓인 고대 별자리로, 프톨레마이오스의 48개 별자리 가운데 하나입니다. 한국에서는 지평선 아래에 머무는 부분이 많지만 남반구에서는 제단 모양의 작은 별무리를 볼 수 있습니다.',
            '고대 시인 아라토스는 남쪽 지평선 가까이에 보이는 제단을 기록하고 그 주변 구름과 바람을 날씨의 징조로 설명했습니다. 별자리가 남쪽 하늘에 낮게 놓인 모습 자체가 항해와 기상 관찰의 기준이 된 셈입니다.',
            '후대의 별자리 해설에서는 올림포스 신들이 티탄과 싸우기 전에 제단 앞에서 동맹을 맹세했다는 전승이 자주 붙습니다. 센타우루스가 이리자리를 제물처럼 제단으로 가져간다는 성도 해석도 있지만, 제단의 기원을 한 가지 신화로만 정하기는 어렵습니다.',
            '제단자리 안의 NGC 6397은 지구에서 가까운 구상성단 가운데 하나입니다. 수많은 오래된 별이 조밀하게 모여 있어 작은 망원경에서는 흐릿한 빛덩이로, 우주망원경 사진에서는 셀 수 없이 많은 별의 무리로 보입니다.'
        ],
        Sculptor: [
            '조각가자리(Sculptor)는 고대 신화가 아니라 니콜라 루이 드 라카유의 남천 관측에서 태어났습니다. 라카유는 1751~1752년 희망봉에서 남쪽 별의 위치를 기록한 뒤, 희미한 별밭에 당시 예술과 과학의 도구를 나타내는 새 별자리를 배치했습니다.',
            '1756년 남천도에 실린 첫 형상은 한 사람의 조각가가 아니라 조각가의 작업실이었습니다. 고전 조각 흉상과 망치, 끌, 작업대가 함께 그려졌고, 라틴어 이름도 ‘조각가의 기구’를 뜻하는 Apparatus Sculptoris로 정리됐습니다.',
            '긴 이름과 복잡한 도구 그림은 이후 간소화되어 오늘날의 Sculptor가 됐습니다. 따라서 이 별자리는 어떤 고대 영웅을 나타내지 않으며, 계몽시대 성도가 인간의 기술과 작업 공간까지 하늘에 올린 사례입니다.',
            '경계 안의 NGC 253은 조각가은하 또는 은화은하로 불리는 거의 옆면 방향의 나선은하입니다. 약 1천만 광년 떨어진 가까운 외부은하 가운데 하나이며, 먼지 띠 사이에서 많은 별이 빠르게 만들어지는 대표적인 폭발적 별 생성 은하입니다.'
        ],
        Caelum: [
            '조각칼자리(Caelum)는 라카유가 1756년 남천도에 처음 실은 근대 별자리입니다. 프랑스어 이름은 ‘조각칼’을 뜻하는 Le Burin이었고, 그의 그림에는 리본으로 묶인 두 종류의 금속 조각 도구가 나타났습니다.',
            '1763년 별 목록에서는 이름이 ‘조각가의 끌’을 뜻하는 라틴어 Caelum Sculptoris로 정리됐습니다. 뒤에 존 허셜의 제안에 따라 명칭이 짧은 Caelum으로 줄어들면서, 복잡한 도구 세트도 하나의 끌을 나타내는 형상으로 단순해졌습니다.',
            '조각칼자리는 면적이 매우 작고 은하수의 밝은 띠에서도 벗어나 있어 눈에 잘 띄지 않습니다. 가장 밝은 알파별도 약 4.5등급이며, 도시 하늘에서는 별자리 윤곽을 찾기 어렵습니다.',
            '밝은 성운이나 메시에 천체도 없어 시각적으로는 조용한 별자리입니다. 그러나 바로 그 희미함 때문에, 고대인이 뚜렷한 별무리에서 발견한 형상이 아니라 관측자가 빈 영역을 측량하고 근대 도구의 이름을 부여한 역사가 선명하게 드러납니다.'
        ],
        Equuleus: [
            '조랑말자리(Equuleus)는 프톨레마이오스의 고대 48개 별자리 가운데 하나이며, 남십자자리 다음으로 작은 현대 별자리입니다. 페가수스자리의 머리 서쪽에 붙은 작은 말머리처럼 보이며 돌고래자리와도 이웃합니다.',
            '이 조랑말의 정체는 하나로 고정되지 않습니다. 케이론의 딸 히페가 말로 변했다는 이야기, 페가수스와 이어지는 빠른 말 켈레리스 이야기, 포세이돈이 만든 말이라는 설명 등이 서로 다른 전승으로 전해집니다.',
            '조랑말자리는 페가수스보다 먼저 떠오른다고 하여 ‘첫 번째 말’이라는 뜻의 Equus Primus로도 불렸습니다. 다만 하늘에 보이는 형상은 말의 몸 전체보다 머리와 목에 가까우며, 신화보다 작은 말이라는 형태 자체가 오래 유지됐습니다.',
            '가장 밝은 알파별 키탈파는 약 3.9등급이고 이름은 아랍어로 ‘말의 한 부분’을 뜻합니다. 밝은 별과 메시에 천체가 거의 없는 조용한 별자리지만, 72제곱도 남짓한 좁은 영역에 고대 별자리의 지위를 그대로 간직하고 있습니다.'
        ],
        Norma: [
            '직각자자리(Norma)는 라카유가 희망봉 관측 뒤 만든 근대 남천 별자리입니다. 1756년에는 제도와 측량에 쓰는 자와 직각자를 함께 그려 ‘자와 직각자’라는 뜻의 이름을 붙였습니다.',
            '이 별자리는 신화 속 물건이 아니라 정확한 선과 각도를 만드는 계몽시대의 도구를 나타냅니다. 긴 라틴어 이름 Norma et Regula는 뒤에 Norma로 줄었고, 오늘날에는 직각자 또는 제도용 삼각자의 형상으로 설명합니다.',
            '현대 별자리 경계를 정리하는 과정에서 라카유가 알파와 베타로 지정했던 별들이 전갈자리 쪽으로 옮겨졌습니다. 그래서 직각자자리에는 현재 알파별과 베타별이 없고, 가장 밝은 별은 약 4등급의 감마2별입니다.',
            '직각자자리는 은하수의 짙은 별밭에 놓여 산개성단이 풍부합니다. NGC 6087의 중심 부근에는 밝기가 규칙적으로 변하는 고전적 세페이드 변광성 S Normae가 있어, 별의 주기와 밝기 관계를 연구하는 데 쓰입니다.'
        ],
        Libra: [
            '천칭자리(Libra)의 별들은 아주 오래전부터 저울과 전갈의 집게라는 두 이미지 사이를 오갔습니다. 메소포타미아에서는 저울을 뜻하는 이름과 전갈의 집게라는 해석이 함께 나타났고, 그리스 성도에서는 전갈자리 앞쪽의 두 집게발로 자주 그렸습니다.',
            '고대 그리스어로 집게를 뜻하는 Chelae라는 이름은 별자리의 오랜 정체를 보여 줍니다. 프톨레마이오스의 별 목록에서도 이 영역은 전갈의 집게로 설명됐으며, 오늘날 전갈자리와 천칭자리가 맞닿아 있는 배치에 그 흔적이 남아 있습니다.',
            '로마 시대에는 두 집게발을 독립된 천칭으로 보는 해석이 굳어졌습니다. 저울은 정의와 질서를 상징해 정의의 여신 아스트라이아 또는 처녀자리와 이어졌고, 천칭자리는 황도 12궁 가운데 유일한 무생물 형상이 됐습니다.',
            '가장 밝은 별들의 이름 주벤엘게누비와 주벤에스카말리는 각각 ‘남쪽 집게’와 ‘북쪽 집게’를 뜻합니다. 별자리 그림은 저울로 바뀌었지만 별 이름은 전갈의 몸에서 떨어져 나온 과거를 지금까지 보존하고 있습니다.'
        ],
        Virgo: [
            '처녀자리(Virgo)는 바다뱀자리 다음으로 넓은 현대 별자리이며, 황도 별자리 가운데 가장 큽니다. 봄철 남쪽 하늘에서 사자자리와 천칭자리 사이에 넓게 퍼져 있어 한눈에 전체 윤곽을 알아보기는 쉽지 않습니다.',
            '하늘의 처녀가 누구인지는 시대와 문화에 따라 달랐습니다. 곡식의 여신 데메테르나 딸 페르세포네, 정의의 여신 디케 또는 아스트라이아 등 여러 인물이 연결되므로 한 여신의 전기로만 설명하기 어렵습니다.',
            '가장 밝은 별 스피카는 라틴어로 ‘곡식의 이삭’을 뜻하며, 전통 성도에서 처녀가 든 밀 이삭 끝에 놓입니다. 실제 스피카는 서로 가까이 도는 두 뜨거운 별로 이루어진 쌍성계입니다.',
            '처녀자리 방향에는 수천 개의 은하가 모인 처녀자리 은하단이 펼쳐집니다. 그 중심부의 거대 타원은하 M87에는 태양 질량의 수십억 배에 이르는 초대질량 블랙홀이 있으며, 2019년 사건지평선망원경이 그 주변의 그림자를 처음 영상화했습니다.'
        ],
        Chamaeleon: [
            '카멜레온자리(Chamaeleon)는 고대 별자리가 아니라 16세기 말 남천 항해 관측에서 태어났습니다. 피터르 디르크스존 케이저와 프레데릭 더하우트만이 동인도 항로에서 기록한 남쪽 별을 바탕으로 페트뤼스 플란시우스가 구성했습니다.',
            '1598년 플란시우스와 요도쿠스 혼디우스의 천구의에 카멜레온이 처음 나타났고, 요한 바이어가 1603년 《우라노메트리아》에 실으면서 널리 알려졌습니다. 유럽 성도에 새로운 동물과 남쪽 별 지식이 함께 들어온 대항해시대의 별자리입니다.',
            '카멜레온자리는 천구 남극 가까이에 놓여 한국에서는 볼 수 없습니다. 가장 밝은 별도 4등급대여서 남반구에서도 화려하지 않으며, 어두운 하늘에 몸을 숨기는 실제 카멜레온처럼 희미한 별들로 이루어져 있습니다.',
            '별자리 경계 안에는 차갑고 짙은 분자운들이 모인 카멜레온 복합체가 있습니다. 약 630광년 떨어진 카멜레온 I 암흑구름에서는 가스와 먼지가 뭉쳐 젊은 별과 원시별이 만들어지고 있으며, 적외선 관측으로 구름 안쪽 구조를 볼 수 있습니다.'
        ],
        Cassiopeia: [
            '카시오페이아자리(Cassiopeia)는 프톨레마이오스의 고대 48개 별자리이며, 다섯 밝은 별이 W 또는 M 모양을 이룹니다. 한국에서는 천구 북극 둘레를 도는 주극 별자리여서 계절에 따라 방향을 바꾸면서도 거의 일 년 내내 북쪽 하늘에서 볼 수 있습니다.',
            '그리스 전승의 카시오페이아는 에티오피아의 왕비입니다. 자신 또는 딸 안드로메다가 바다의 님프 네레이데스보다 아름답다고 자랑하자 포세이돈이 홍수와 바다괴물 케토스를 보내고, 안드로메다가 제물로 바쳐질 위기에 놓였습니다.',
            '왕비는 벌로 의자에 묶인 채 하늘에 올라 북극 둘레를 돌며 때때로 거꾸로 매달리는 운명이 됐다고 전합니다. 실제 W가 계절과 시각에 따라 M이나 옆으로 기운 모양으로 바뀌는 모습에 신화적 처벌을 겹쳐 읽은 이야기입니다.',
            '1572년 티코 브라헤는 카시오페이아에 나타난 새로운 별 SN 1572를 정밀하게 관측해 하늘도 변할 수 있음을 보여 줬습니다. 카시오페이아 A는 이 별과 다른 폭발의 잔해로, 약 1만1천 광년 떨어진 곳에서 팽창하는 가스와 원소를 적외선과 X선으로 관측합니다.'
        ],
        Circinus: [
            '컴퍼스자리(Circinus)는 고대 신화가 아니라 니콜라 루이 드 라카유의 남천 측량에서 태어난 근대 별자리입니다. 라카유는 1751년부터 1752년까지 남아프리카 희망봉에서 남쪽 별들의 위치를 재었고, 1756년 남천도에 프랑스어로 ‘르 콩파’라는 새 별자리를 실었습니다. 그가 세상을 떠난 뒤 1763년에 출간된 남천성표에서는 라틴어 Circinus로 정리됐습니다.',
            '이름의 컴퍼스는 방향을 찾는 나침반이 아니라 원을 그리거나 거리를 옮기는 두 다리의 제도 도구입니다. 나침반자리는 별개의 Pyxis이며, 라카유는 컴퍼스·직각자·현미경·시계처럼 계몽시대의 과학과 기술을 상징하는 기구들을 남쪽 하늘에 배치했습니다.',
            '가장 밝은 알파 컴퍼스자리별도 약 3.2등급이라 별무늬가 화려하지는 않습니다. 이 별은 강한 자기장과 특이한 화학 조성을 지닌 Ap별이며, 몇 분 단위로 밝기가 미세하게 달라지는 빠르게 맥동하는 Ap별의 대표 사례입니다.',
            '컴퍼스자리 방향에는 약 1천3백만 광년 떨어진 컴퍼스은하가 있습니다. 중심의 초대질량 블랙홀이 주변 물질을 끌어들이는 활동은하이지만 우리은하 원반의 가스와 먼지 뒤에 가려져 있습니다. 별자리의 별과 이 은하는 실제 한 무리가 아니라 지구에서 같은 방향에 겹쳐 보일 뿐입니다.'
        ],
        Crater: [
            '컵자리(Crater)의 라틴어 이름은 고대 그리스의 큰 혼합용 그릇 크라테르에서 왔습니다. 크라테르는 포도주에 물을 섞어 여러 사람이 나누던 넓은 그릇으로, 오늘날의 작은 찻잔이나 손잡이 달린 머그와는 모습이 다릅니다. 프톨레마이오스는 2세기 별 목록에서 컵자리를 고대 48개 별자리 가운데 하나로 기록했습니다.',
            '하늘에서 컵자리는 길게 뻗은 바다뱀자리의 등 위에 놓이고 가까이에 까마귀자리가 있습니다. 고대 성도는 세 별자리를 서로 떨어진 그림이 아니라 물뱀의 몸 위에 잔과 새가 함께 놓인 하나의 장면처럼 표현했습니다.',
            '히기누스의 천문 신화에는 아폴론이 까마귀에게 제사에 쓸 물을 가져오라고 했다는 이야기가 실립니다. 까마귀는 무화과가 익기를 기다리느라 늦은 뒤 물뱀 때문에 물을 뜨지 못했다고 둘러댔습니다. 아폴론은 거짓말을 알아차리고 까마귀·잔·물뱀을 함께 하늘에 놓아 까마귀가 잔에 닿지 못하게 했다고 전합니다. 다만 컵을 설명하는 고대 전승이 이것 하나뿐인 것은 아닙니다.',
            '컵자리에는 3등급보다 밝은 별이 없으며 가장 밝은 델타별은 약 3.6등급의 주황색 거성입니다. 그리스 문자의 순서가 항상 밝기 순서를 뜻하지는 않는 사례입니다. 이 방향에는 약 4천3백만 광년 떨어져 비스듬히 기울어 보이는 나선은하 NGC 3511도 있습니다.'
        ],
        'Canis Major': [
            '큰개자리(Canis Major)는 프톨레마이오스가 정리한 고대 48개 별자리 가운데 하나입니다. 라틴어 이름은 ‘더 큰 개’를 뜻하며, 실제 하늘에서도 오리온자리의 남동쪽에 놓여 오리온을 따르는 큰 사냥개로 널리 읽혔습니다.',
            '그러나 이 개의 정체를 하나로 고정할 수는 없습니다. 고대 천문 신화에는 오리온의 개, 이카리오스의 개, 어떤 짐승도 놓치지 않던 전설의 사냥개 등 서로 다른 설명이 함께 남아 있습니다. 따라서 ‘오리온의 충성스러운 개’는 대표적인 해석이지만 유일한 고대 정답은 아닙니다.',
            '알파별 시리우스는 겉보기등급 약 -1.46으로 태양을 제외하면 밤하늘에서 가장 밝게 보이는 별입니다. 약 8.6광년으로 비교적 가까운 데다 본래 밝기도 큽니다. 실제로는 눈부신 시리우스 A와 지구만 한 크기에 태양에 가까운 질량을 지닌 백색왜성 시리우스 B가 약 50년 주기로 서로 도는 쌍성계입니다.',
            '시리우스 남쪽에는 약 2천3백 광년 떨어진 산개성단 M41이 있습니다. 어두운 하늘에서는 희미한 빛무리처럼 보이지만 망원경으로 보면 많은 청백색 별과 몇몇 붉은 거성이 흩어져 있습니다. 시리우스와 가까이 보일 뿐 실제 거리는 크게 다릅니다.'
        ],
        'Ursa Major': [
            '큰곰자리(Ursa Major)는 프톨레마이오스의 고대 48개 별자리에 포함된 북쪽 하늘의 대표 별자리입니다. 널리 알려진 그리스 전승에서는 칼리스토가 곰으로 변한 뒤 하늘에 놓이지만, 누가 그녀를 곰으로 바꾸었고 어떻게 별이 되었는지는 문헌마다 다릅니다.',
            '가장 익숙한 부분은 일곱 밝은 별이 이루는 북두칠성입니다. 그러나 북두칠성은 큰곰자리 전체가 아니라 그 안에 있는 별무리, 곧 아스테리즘입니다. 같은 일곱 별을 고대 그리스에서는 곰뿐 아니라 수레나 쟁기의 모습으로도 불렀습니다.',
            '국자 앞쪽의 메라크와 두베를 이은 선을 연장하면 작은곰자리의 북극성 방향을 찾을 수 있습니다. 손잡이 가운데의 미자르와 알코르는 시력이 좋고 하늘이 맑으면 맨눈으로도 나란히 구분되는 유명한 별쌍입니다. 북두칠성의 별들이 모두 같은 거리의 평면에 놓인 것은 아닙니다.',
            '큰곰자리 방향에는 M81과 M82라는 가까운 은하 쌍도 있습니다. M81은 약 1천2백만 광년 거리의 큰 나선은하이고, M82는 활발한 별 생성과 가스 분출로 붉게 빛나는 은하입니다. 두 은하는 과거 서로 강한 중력 영향을 주고받았습니다.'
        ],
        Tucana: [
            '큰부리새자리(Tucana)는 고대 신화가 아니라 16세기 말 유럽의 남천 항해와 관측에서 태어났습니다. 피터르 디르크스존 케이저와 프레데릭 더하우트만이 동인도 항로에서 남쪽 별을 기록했고, 그 자료를 바탕으로 페트뤼스 플란시우스의 1598년 천구의에 새 남천 별자리들이 나타났습니다.',
            '요한 바이어가 1603년 《우라노메트리아》에 이 별자리를 그리면서 널리 알려졌고, 오늘날 라틴어 Tucana는 남아메리카의 큰부리새를 뜻합니다. 다만 초기 네덜란드어 목록의 새 이름과 묘사는 다른 열대 조류를 가리켰을 가능성도 있어, 항해자들이 큰부리새를 직접 보고 그대로 옮겼다고 단정할 수는 없습니다.',
            '큰부리새자리 방향에는 우리은하의 위성 왜소은하인 소마젤란은하가 넓게 펼쳐집니다. 약 20만 광년 떨어진 가까운 이웃 은하로, 우리은하보다 무거운 원소가 적은 환경에서 별이 만들어지는 과정을 연구할 수 있습니다.',
            '소마젤란은하 옆에는 47 투카나에, 곧 NGC 104라는 밝은 구상성단이 보입니다. 약 1만7천 광년 거리에서 수십만 개 이상의 오래된 별이 빽빽하게 모인 우리은하 성단입니다. 두 천체는 사진에서 붙어 보이지만 47 투카나에가 훨씬 앞쪽에 있어 서로 다른 천체입니다.'
        ],
        Mensa: [
            '테이블산자리(Mensa)는 라카유가 1751년부터 1752년까지 케이프에서 남쪽 하늘을 관측한 뒤 만든 근대 별자리입니다. 1756년 남천도에는 프랑스어로 테이블산을 뜻하는 이름이 실렸고, 1763년 사후 출간된 성표에서는 라틴어 Mons Mensae로 정리됐습니다. 오늘날 이름 Mensa는 이를 짧게 줄인 것입니다.',
            '이름의 모델은 식탁이 아니라 남아프리카공화국 케이프타운의 테이블산입니다. 평평한 정상에 흰 구름이 걸리는 모습을 식탁보에 비유한 풍경과, 산 위로 보이는 큰마젤란운을 한 장면처럼 연결했습니다. 현대 88개 별자리 가운데 지상의 실제 지형에서 이름을 가져온 독특한 사례입니다.',
            '테이블산자리는 매우 희미합니다. 가장 밝은 알파별조차 약 5.1등급이어서 도시에서는 찾기 어렵고 한눈에 알아볼 만한 밝은 별무늬도 없습니다. 눈에 띄는 별의 모양보다 케이프의 지형과 라카유의 관측사가 별자리의 정체성을 만들었습니다.',
            '큰마젤란운은 약 16만 광년 떨어진 우리은하의 위성 왜소은하로 황새치자리와 테이블산자리에 걸쳐 보입니다. 이 별자리의 태양과 비슷한 별 파이 멘사이 주위에는 TESS가 처음 확인한 행성 가운데 하나인 파이 멘사이 c가 있으며, 약 6일마다 별을 한 바퀴 돕니다.'
        ],
        Lepus: [
            '토끼자리(Lepus)는 고대부터 알려진 별자리입니다. 기원전 3세기 시인 아라토스는 오리온의 두 발 아래에 토끼가 놓이고 시리우스가 뒤에서 쫓는다고 묘사했습니다. 프톨레마이오스도 2세기 별 목록에서 토끼자리를 고대 48개 별자리 가운데 하나로 기록했습니다.',
            '‘오리온이 사냥하는 토끼’만이 유일한 설명은 아닙니다. 히기누스는 헤르메스가 토끼의 강한 번식력을 기려 하늘에 올렸다는 이야기와, 토끼가 지나치게 늘어나 농작물을 망친 레로스섬의 경고담도 함께 기록했습니다. 서로 다른 전승이 하나의 별자리에 겹쳐 남은 것입니다.',
            '전통 성도에서는 긴 귀와 뒷다리를 지닌 야생 산토끼로 그리는 경우가 많습니다. 실제 하늘에서도 토끼자리는 오리온 아래, 큰개자리와 시리우스 가까이에 놓여 고대 문헌의 추격 구도를 그대로 확인할 수 있습니다. 시리우스는 토끼자리의 별이 아니라 큰개자리의 별입니다.',
            '대표 심원천체 M79는 피에르 메생이 1780년에 발견한 구상성단으로 약 4만1천 광년 떨어져 있습니다. 수많은 오래된 별이 둥글게 모인 천체이며, 다른 작은 은하에서 우리은하로 들어왔을 가능성도 연구됐지만 그 기원이 확정된 것은 아닙니다.'
        ],
        Musca: [
            '파리자리(Musca)는 16세기 말 유럽의 남천 항해에서 생긴 근대 별자리입니다. 케이저와 더하우트만이 항해 중 기록한 남쪽 별을 바탕으로 플란시우스의 1598년 천구의에 작은 곤충 형상이 나타났습니다. 정확히 누가 곤충의 이름을 처음 골랐는지는 분명하지 않습니다.',
            '요한 바이어는 1603년 《우라노메트리아》에서 이 별자리를 벌을 뜻하는 Apis로 표시했습니다. 이후 성도에서는 파리라는 이름이 널리 쓰였고, 한때 사라진 북쪽 파리자리와 구분하려고 Musca Australis라고 부르기도 했습니다. 오늘날 IAU의 공식 이름은 짧게 Musca입니다.',
            '파리자리 북쪽에는 석탄자루성운의 일부가 걸쳐 있습니다. 별이 없는 구멍이 아니라 차갑고 짙은 먼지가 뒤쪽 은하수의 별빛을 가리는 암흑성운입니다. 주변의 밝은 별밭과 대비되기 때문에 맨눈에도 검은 얼룩처럼 보입니다.',
            'NGC 5189는 약 1천8백 광년 떨어진 행성상성운입니다. 행성과는 관계가 없고 죽어 가는 별이 바깥층을 우주로 내보내며 만든 가스 껍질입니다. 서로 다른 방향의 푸른 엽과 금빛 필라멘트가 얽힌 복잡한 형태여서 단순한 원이나 한 줄의 나선으로 설명하기 어렵습니다.'
        ],
        Octans: [
            '팔분의자리(Octans)는 라카유가 케이프 관측 뒤 만든 근대 남천 별자리 가운데 하나입니다. 1756년 지도에는 ‘반사 팔분의’를 뜻하는 프랑스어 이름으로 실렸고, 1763년 라틴어 성표에서 Octans로 정리됐습니다. 과학기구를 하늘에 옮긴 계몽시대 별자리라 고대 신화는 없습니다.',
            '팔분의는 원의 8분의 1에 해당하는 원호를 가진 항해용 각도 측정기입니다. 존 해들리와 토머스 고드프리는 1730년 무렵 서로 독립적으로 비슷한 반사 팔분의를 만들었습니다. 거울로 태양이나 별과 수평선을 한 시야에 겹친 뒤 고도를 재어 선박의 위도를 구하는 데 사용했습니다.',
            '현대 팔분의자리 경계 안에는 하늘의 남극이 들어 있습니다. 남극은 천구 위의 방향이지 실제 별이 아닙니다. 지구가 자전하기 때문에 남반구에서 긴 노출로 하늘을 찍으면 주위 별들이 그 빈 점을 중심으로 원을 그리는 것처럼 보입니다.',
            '남극성으로 불리는 시그마 옥탄티스는 남극점에서 약 1도 떨어져 있지만 약 5.4등급으로 맨눈에 겨우 보입니다. 북극성처럼 눈에 잘 띄는 길잡이가 아니어서 실제로 남쪽 방향을 찾을 때는 남십자자리의 밝은 별을 이용하는 편이 쉽습니다.'
        ],
        Pegasus: [
            '페가수스자리(Pegasus)는 프톨레마이오스가 기록한 고대 48개 별자리 가운데 하나입니다. 가장 널리 알려진 해석은 날개 달린 말 페가수스지만, 고대 천문 신화에는 케이론의 딸 멜라니페가 암말로 변해 하늘에 올랐다는 다른 설명도 남아 있습니다.',
            '대표 전승에서 페가수스는 페르세우스가 메두사의 목을 벤 뒤 태어납니다. 이후 벨레로폰이 페가수스를 타고 불을 뿜는 키마이라를 물리쳤습니다. 벨레로폰은 하늘에 오르려다 추락하지만 페가수스는 올림포스에 올라 제우스의 벼락을 나르는 말이 됐다고 전합니다. 페르세우스와 벨레로폰의 역할을 바꾸어 그리면 다른 이야기가 됩니다.',
            '관측에서 가장 눈에 띄는 모양은 ‘페가수스의 큰 사각형’입니다. 마르카브·셰아트·알게니브는 페가수스자리의 별이지만 네 번째 꼭짓점 알페라츠는 현대 경계상 안드로메다자리의 알파별입니다. 큰 사각형은 공식 별자리 전체가 아니라 두 별자리에 걸친 별무리입니다.',
            '페가수스자리에는 약 120억 년 된 구상성단 M15와 외계행성 51 페가수스 b가 있습니다. 1995년에 발견된 51 페가수스 b는 태양과 비슷한 별 주위에서 처음 확인된 외계행성이며 약 4.2일 만에 별을 도는 뜨거운 목성형 행성입니다. 펄서 주위 행성은 그보다 먼저 발견됐으므로 모든 외계행성 가운데 최초라는 뜻은 아닙니다.'
        ],
        Perseus: [
            '페르세우스자리(Perseus)는 프톨레마이오스가 기록한 고대 48개 별자리 가운데 하나입니다. 전통 성도에서는 칼과 메두사의 머리를 든 영웅으로 그리며, 안드로메다·카시오페이아·세페우스·고래자리와 한 신화의 무대를 이룹니다. 현대 IAU 별자리는 이 그림 자체가 아니라 정해진 경계 안의 하늘 영역입니다.',
            '그리스 전승에서 페르세우스는 반사되는 방패로 메두사를 직접 보지 않고 물리칩니다. 돌아오는 길에는 바위에 묶인 안드로메다를 발견해 바다괴물 케토스에게서 구합니다. 고대 문헌에서는 날개 달린 신발로 날며, 페가수스를 타는 장면은 후대 미술에서 널리 더해진 표현이므로 벨레로폰 전승과 구분해야 합니다.',
            '베타별 알골은 마법처럼 사라지는 별이 아니라 삼중성계입니다. 그 안의 가까운 두 별이 지구에서 보이는 선상에서 서로를 가리는 식쌍성을 이루어 약 2.87일마다 밝기가 크게 낮아집니다. 별자리 그림 속 메두사의 눈과 실제 밝기 변화는 서로 다른 층위의 이야기입니다.',
            '8월의 페르세우스 유성우는 스위프트-터틀 혜성이 남긴 입자가 대기에서 빛나는 현상이며, 유성의 진행 방향을 거슬러 올리면 페르세우스자리에서 퍼지는 것처럼 보입니다. NGC 869와 NGC 884 이중성단은 약 7천5백 광년 떨어진 두 산개성단으로, 쌍안경에서 나란한 별무리로 드러납니다.'
        ],
        Hercules: [
            '헤라클레스자리(Hercules)는 프톨레마이오스의 고대 48개 별자리이지만 처음부터 영웅의 이름이 확정된 것은 아닙니다. 아라토스는 정체를 알 수 없는 채 무릎을 꿇고 고된 일을 하는 인물로 묘사했고, 후대 천문 신화가 이를 헤라클레스와 연결했습니다.',
            '그리스 신화의 헤라클레스는 로마에서 Hercules로 불렸습니다. 그는 에우리스테우스가 내린 열두 과업을 수행하며, 첫 과업에서 쓰러뜨린 네메아 사자의 가죽과 큰 곤봉이 대표 표지가 됐습니다. 별자리 그림도 흔히 무릎 꿇은 영웅이 곤봉과 사자 가죽을 든 모습으로 그립니다.',
            '실제 하늘에서는 별자리 전체가 매우 넓지만 밝은 별이 적어 영웅의 형상을 한눈에 찾기 어렵습니다. 중심의 네 별이 이루는 사각형은 ‘쐐기돌(Keystone)’이라는 별무리이며, IAU가 정한 별도의 별자리는 아닙니다. 베가와 아크투루스 사이에서 이 네 별을 먼저 찾으면 위치를 잡기 쉽습니다.',
            '쐐기돌 안쪽의 M13은 약 2만5천 광년 떨어진 구상성단으로 수십만 개의 오래된 별이 거의 구형으로 모여 있습니다. 1974년 아레시보 전파망원경은 M13 방향으로 인류 정보를 담은 메시지를 보냈지만 주로 상징적인 시도였고, 답을 받는다면 왕복에 거의 5만 년이 걸립니다.'
        ],
        Microscopium: [
            '현미경자리(Microscopium)는 고대 신화가 아니라 니콜라 루이 드 라카유의 남천 관측에서 태어난 근대 별자리입니다. 라카유는 1751년부터 1752년까지 남아프리카 희망봉에서 남쪽 별들의 위치를 측정하고 영웅이나 동물 대신 과학·기술의 도구를 나타내는 새 별자리들을 만들었습니다.',
            '1756년 남천도에는 프랑스어 Le Microscope라는 이름으로 실렸고, 1763년 사후 출간된 남천성표에서는 라틴어 Microscopium으로 정리됐습니다. 특정 신화나 영웅을 기념한 것이 아니라 보이지 않던 작은 세계를 연 현미경이라는 과학기구를 하늘에 배치한 것입니다.',
            '주요 별들이 희미해 도시 하늘에서는 현미경 모양을 찾아내기 어렵습니다. 라카유가 그린 현미경은 역사적 성도의 그림이며, 현대 IAU는 특정 선 그림을 공식 형상으로 정하지 않습니다. 오늘날 현미경자리는 그림이 아니라 좌표 경계로 구분되는 남쪽 하늘의 영역입니다.',
            '이 경계 안의 AU 마이크로스코피이(AU Mic)는 약 32광년 떨어진 젊고 활동적인 적색왜성입니다. 충돌한 작은 천체가 만든 먼지원반이 거의 옆면으로 보이며, NASA 외계행성 아카이브에는 2026년 8월 현재 b·c·d·e 네 행성이 등재돼 있습니다. 희미한 별무늬 안에 실제 젊은 행성계가 놓인 셈입니다.'
        ],
        Pictor: [
            '화가자리(Pictor)는 라카유가 희망봉에서 남쪽 하늘을 관측한 뒤 만든 근대 별자리입니다. 프톨레마이오스의 고대 48개 별자리에는 없으며 영웅이나 신에 관한 고대 전승도 없습니다. 남천의 빈 영역을 당시 예술과 과학의 도구로 정리한 결과입니다.',
            '라카유의 1756년 지도에 적힌 이름은 Le Chevalet et la Palette, 곧 ‘이젤과 팔레트’였습니다. 1763년 성표에서는 화가의 이젤을 뜻하는 Equuleus Pictorius로 정리됐고 오늘날 공식 명칭은 짧은 Pictor입니다. 한국어 이름은 화가자리지만 원래 핵심 대상은 사람인 화가가 아니라 이젤과 팔레트였습니다.',
            '베타 픽토리스는 약 63광년 떨어진 젊은 별이며, 작은 천체들의 충돌 잔해로 이루어진 거대한 먼지원반을 거의 옆면으로 보여 줍니다. 이 원반은 1984년에 처음 직접 촬영됐고, 휘어진 구조와 떨어지는 혜성 물질은 행성의 존재를 암시했습니다.',
            '2026년 7월 ESO는 기존 b·c에 이어 세 번째 거대행성 베타 픽토리스 d를 발표했습니다. d는 b보다 약 100배 희미하고 목성 질량의 약 2.4배이며, ESO·JWST 보관 자료를 합친 11년간의 관측 기록에서도 확인됐습니다. 세 행성을 함께 연구하면 한 행성계 안에서 서로 다른 거대행성이 형성되고 진화하는 과정을 비교할 수 있습니다.'
        ],
        Fornax: [
            '화로자리(Fornax)는 고대 신화에서 내려온 별자리가 아니라 라카유가 희망봉에서 남쪽 하늘을 측량한 뒤 만든 근대 별자리입니다. 1756년 남천도에 처음 발표됐으며 초기 라틴어 이름 Fornax Chemica는 ‘화학용 화로’를 뜻합니다.',
            '여기서 화로는 집을 데우는 벽난로나 빵을 굽는 화덕이 아닙니다. 도가니와 레토르트 속 물질을 일정하게 가열해 화학 반응과 증류를 진행하던 실험 장치입니다. 망원경·현미경·공기펌프처럼 과학기구를 남천에 배치한 라카유의 계몽시대적 구상을 보여 줍니다.',
            '가장 밝은 알파 화로자리별도 약 3.9등급인 쌍성계여서 별자리 자체는 눈에 잘 띄지 않습니다. 그러나 이 방향에는 약 6천5백만 광년 떨어진 포낙스 은하단이 있으며, 중심의 거대 타원은하 NGC 1399와 막대나선은하 NGC 1365 등 여러 형태의 은하가 중력으로 모여 있습니다.',
            '허블 울트라 딥 필드는 화로자리에서 지상 관측상 거의 비어 보이던 작은 영역을 장시간 촬영해 만든 영상입니다. 2004년 공개 영상에는 약 1만 개의 은하가 담겼습니다. 포낙스 은하단과 딥 필드의 은하들이 한 무리라는 뜻은 아니며 서로 매우 다른 거리의 천체가 같은 방향에 겹쳐 보입니다.'
        ],
        Sagitta: [
            '화살자리(Sagitta)는 프톨레마이오스가 기록한 고대 48개 별자리 가운데 하나이며 라틴어 이름은 그대로 ‘화살’을 뜻합니다. 궁수자리의 활과 화살과는 별개의 별자리로, 고대 성도에서는 활 없이 홀로 날아가는 화살 한 대로 그려졌습니다.',
            '화살의 주인을 하나로 고정할 수는 없습니다. 널리 알려진 전승에서는 헤라클레스가 프로메테우스의 간을 쪼아 먹던 독수리를 쓰러뜨린 화살이라고 하지만, 아폴론이나 에로스의 화살이라는 설명도 전해집니다. 헤라클레스 이야기는 대표 해석이지 유일한 정답은 아닙니다.',
            '화살자리는 현대 88개 별자리 중 세 번째로 작지만 몇 개의 3~4등급 별이 짧고 선명한 화살 모양을 만듭니다. 화살대 부근의 M71은 약 1만3천 광년 떨어진 느슨한 구상성단입니다. 중심 집중도가 낮아 한동안 산개성단으로 분류되기도 했습니다.',
            '화살을 닮은 실제 유성은 별이나 별자리 조각이 떨어지는 현상이 아닙니다. 유성체가 초고속으로 대기에 들어오면 앞쪽 공기가 압축되고, 대기 분자와 기화된 원소가 충돌·여기·이온화되면서 빛을 냅니다. 물체가 단순히 불꽃처럼 ‘타는 현상’으로만 설명하면 정확하지 않습니다.'
        ],
        Dorado: [
            '황새치자리(Dorado)는 16세기 말 네덜란드 항해자들의 남천 관측에서 태어난 근대 별자리입니다. 피터르 디르크스존 케이저와 프레데릭 더하우트만의 기록을 바탕으로 플란시우스가 구성했으며, 1598년경 천구의와 1603년 바이어의 《우라노메트리아》를 통해 널리 알려졌습니다.',
            '한국어 관용명은 황새치자리지만 Dorado가 가리키는 물고기는 오늘날 dolphinfish, 곧 만새기 또는 하와이 이름 마히마히로 설명됩니다. 포유류 돌고래와 관계없고 긴 칼 모양 주둥이를 가진 황새치와도 다른 물고기입니다. 전형적인 황새치로 단정하면 명칭의 역사적 뉘앙스를 놓치게 됩니다.',
            '황새치자리 방향에는 약 16만 광년 떨어진 우리은하의 위성 왜소은하 큰마젤란운이 넓게 펼쳐집니다. 일부는 이웃 테이블산자리 경계에 걸치며, 맨눈에는 떨어져 나온 은하수 조각처럼 보이지만 실제로는 수많은 별·성운·성단을 거느린 독립된 은하입니다.',
            '큰마젤란운의 30 도라두스, 곧 타란툴라성운은 폭이 1천 광년을 넘는 매우 밝고 활발한 별 생성 영역입니다. 같은 은하에서는 1987년 2월 23일 SN 1987A의 폭발빛이 관측됐고, 천문학자들은 지금도 밝은 고리와 충격파의 변화를 추적하고 있습니다.'
        ],
        Taurus: [
            '황소자리(Taurus)는 오래전부터 알려진 황도 별자리이며 프톨레마이오스의 고대 48개 별자리에도 포함됩니다. 전통 성도에서는 황소의 전신보다 머리·뿔·앞부분을 중심으로 그렸습니다. 태양과 달, 행성들이 지나는 황도 위에 놓여 여러 문화의 달력과 계절 관측에서도 중요한 영역이었습니다.',
            '그리스 전승의 대표 해석에서는 제우스가 아름다운 흰 황소로 변해 에우로페에게 다가간 뒤 그녀를 등에 태우고 크레타섬으로 건너갑니다. 다만 황소 형상은 그리스보다 오래된 문화권에서도 나타나므로 모든 황소자리 전통이 이 이야기에서 시작됐다고 단정할 수는 없습니다.',
            'V자 모양의 히아데스 성단은 황소의 얼굴을 이루고 주황빛 알데바란은 한쪽 눈처럼 보입니다. 그러나 알데바란은 히아데스 구성원이 아닙니다. 약 151광년 거리의 성단보다 절반 이상 가까운 앞쪽에 있으며, 지구에서 같은 시선 방향에 놓여 성단 안의 별처럼 보일 뿐입니다.',
            '황소자리에는 약 400광년 떨어진 플레이아데스 성단 M45도 있습니다. 히아데스·알데바란과 물리적으로 한 무리가 아닙니다. 뿔 부근의 게성운 M1은 1054년에 관측된 초신성이 남긴 팽창하는 잔해이며 중심에는 빠르게 회전하는 중성자별인 게성운 펄서가 남아 있습니다.'
        ]
    };
    ...
    const STORY_WEBTOONS = {
        ...
        Grus: {
            src: './assets/webtoons/23-grus-webtoon.webp',
            width: 864,
            height: 1821,
            title: '항해자의 지도에서 날아오른 두루미',
            episode: 'WEBTOON 23 / 88',
            alt: '유럽에서 보기 어려운 남쪽 별을 케이저와 더하우트만이 관측하고, 1598년 천구의와 1603년 더하우트만의 목록·바이어의 성도를 거쳐 두루미자리가 정착한 역사를 네덜란드 해양 목판화풍으로 그린 5컷 웹툰'
        },
        Auriga: {
            src: './assets/webtoons/24-auriga-webtoon.webp',
            width: 864,
            height: 1821,
            title: '네 마리 말의 마차와 카펠라',
            episode: 'WEBTOON 24 / 88',
            alt: '고대 마차부가 고삐를 쥔 모습과 에리크토니오스의 사두마차 발명 전승, 서로 다른 마차부 후보, 카펠라와 두 새끼 염소의 도상이 겹쳐진 역사를 그리스 적회식 도기와 밀랍화풍으로 그린 5컷 웹툰'
        },
        Telescopium: {
            src: './assets/webtoons/25-telescopium-webtoon.webp',
            width: 863,
            height: 1822,
            title: '남쪽 하늘에 세운 긴 망원경',
            episode: 'WEBTOON 25 / 88',
            alt: '라카유가 희망봉에서 남천을 관측하고 긴 공중망원경을 별그림으로 옮겨 망원경자리가 현대 88개 별자리로 남는 과정을 청록빛 과학 동판화풍으로 그린 5단 웹툰'
        },
        'Coma Berenices': {
            src: './assets/webtoons/26-coma-berenices-webtoon.webp',
            width: 864,
            height: 1821,
            title: '사라진 머리카락이 된 별',
            episode: 'WEBTOON 26 / 88',
            alt: '베레니케 2세가 남편의 무사 귀환을 빌며 머리카락을 바치고, 사라진 봉헌물을 코논이 하늘의 별무리로 가리켜 머리털자리가 되는 전승을 프톨레마이오스 시대 채색화풍으로 그린 5단 웹툰'
        },
        Bootes: {
            src: './assets/webtoons/27-bootes-webtoon.webp',
            width: 862,
            height: 1825,
            title: '곰 뒤를 걷는 여러 이름',
            episode: 'WEBTOON 27 / 88',
            alt: '큰곰자리 뒤의 목동을 아르카스·이카리오스·필로멜로스와 연결한 서로 다른 고대 전승과 밝은 별 아르크투루스를 적회식 도기화풍으로 구분해 그린 5단 웹툰'
        },
        Pisces: {
            src: './assets/webtoons/28-pisces-webtoon.webp',
            width: 864,
            height: 1820,
            title: '두 꼬리를 잇는 매듭',
            episode: 'WEBTOON 28 / 88',
            alt: '바빌로니아의 ‘꼬리들’에서 시작해 아프로디테와 에로스가 물고기로 변하거나 두 물고기에게 구조되는 서로 다른 전승과, 꼬리가 매듭으로 이어진 물고기자리 성도를 층층이 자른 종이 디오라마로 그린 5단 웹툰'
        },
        Aquarius: {
            src: './assets/webtoons/29-aquarius-webtoon.webp',
            width: 864,
            height: 1821,
            title: '물을 따르는 자의 여러 얼굴',
            episode: 'WEBTOON 29 / 88',
            alt: '바빌로니아의 ‘위대한 자’와 물의 신 에아에서 가니메데스·데우칼리온·케크롭스라는 서로 다른 그리스 해석을 거쳐 물줄기가 남쪽물고기자리로 이어지는 모습을 남색 바틱과 은실 자수로 그린 5단 웹툰'
        },
        Hydra: {
            src: './assets/webtoons/30-hydra-webtoon.webp',
            width: 864,
            height: 1820,
            title: '무화과와 늦은 심부름',
            episode: 'WEBTOON 30 / 88',
            alt: '한 머리의 긴 바다뱀자리 아래에서 아폴론의 물 심부름을 미룬 까마귀가 물뱀을 핑계 삼고, 바다뱀·잔·까마귀가 함께 별자리가 되는 전승을 중세 채색 필사본풍으로 그린 5단 웹툰'
        },
        Scutum: {
            src: './assets/webtoons/31-scutum-webtoon.webp',
            width: 865,
            height: 1819,
            title: '왕의 승리를 새긴 별의 방패',
            episode: 'WEBTOON 31 / 88',
            alt: '1683년 빈 전투와 얀 3세 소비에스키를 기린 헤벨리우스의 방패가 근대 별자리로 정착하고 M11 야생오리성단과 만나는 역사를 폴란드 문장 동판화풍으로 그린 5단 웹툰'
        },
        Cygnus: {
            src: './assets/webtoons/32-cygnus-webtoon.webp',
            width: 866,
            height: 1816,
            title: '백조가 된 여러 이야기',
            episode: 'WEBTOON 32 / 88',
            alt: '은하수의 백조를 레다와 제우스, 파에톤을 애도한 퀴크노스라는 서로 다른 전승으로 구분하고 데네브와 북십자까지 이어지는 모습을 은염 포토그램풍으로 그린 5단 웹툰'
        },
        Serpens: {
            src: './assets/webtoons/33-serpens-webtoon.webp',
            width: 864,
            height: 1820,
            title: '둘로 갈린 하나의 뱀',
            episode: 'WEBTOON 33 / 88',
            alt: '한 몸의 뱀과 치유의 약초 전승을 거쳐 뱀머리와 뱀꼬리로 갈리지만 하나의 별자리로 남은 뱀자리를 네온 해부학 라이트박스풍으로 그린 5단 웹툰'
        },
        Ophiuchus: {
            src: './assets/webtoons/34-ophiuchus-webtoon.webp',
            width: 864,
            height: 1820,
            title: '죽음을 거슬러 별이 된 의사',
            episode: 'WEBTOON 34 / 88',
            alt: '아스클레피오스가 케이론에게 의술을 배우고 죽은 이를 되살린 뒤 제우스의 번개를 맞아 하늘의 뱀주인으로 남는 전승을 옻칠 자개상감풍으로 그린 5단 웹툰'
        },
        'Corona Borealis': {
            src: './assets/webtoons/35-corona-borealis-webtoon.webp',
            width: 865,
            height: 1819,
            title: '아리아드네의 별빛 왕관',
            episode: 'WEBTOON 35 / 88',
            alt: '아리아드네가 미궁 탈출을 돕고 낙소스에서 디오니소스를 만나 혼인 관이 북쪽왕관자리로 오르는 전승을 미노아 프레스코와 오프셋 석판화풍으로 그린 5단 웹툰'
        },
        Phoenix: {
            src: './assets/webtoons/36-phoenix-webtoon.webp',
            width: 866,
            height: 1817,
            title: '남쪽 하늘에 다시 태어난 새',
            episode: 'WEBTOON 36 / 88',
            alt: '항해자들의 남천 기록과 플란시우스·바이어의 성도를 거쳐 불사조자리가 만들어지고 헤로도토스와 후대 재생 전승이 구분되는 과정을 칠보 에나멜풍으로 그린 5단 웹툰'
        },
        Columba: {
            src: './assets/webtoons/37-columba-webtoon.webp',
            width: 864,
            height: 1820,
            title: '올리브 잎을 문 하늘의 비둘기',
            episode: 'WEBTOON 37 / 88',
            alt: '플란시우스가 노아의 비둘기로 만든 별자리와 올리브 잎의 방주 전승, 별도인 아르고호의 비둘기 이야기를 델프트 도자기 타일풍으로 구분해 그린 5단 웹툰'
        },
        'Canes Venatici': {
            src: './assets/webtoons/38-canes-venatici-webtoon.webp',
            width: 864,
            height: 1821,
            title: '번역의 틈에서 달려온 두 사냥개',
            episode: 'WEBTOON 38 / 88',
            alt: '미정형별과 중세 번역의 혼선을 거쳐 헤벨리우스가 아스테리온과 카라를 독립된 사냥개자리로 만드는 과정을 금박 가죽 장정풍으로 그린 5단 웹툰'
        },
        Leo: {
            src: './assets/webtoons/39-leo-webtoon.webp',
            width: 864,
            height: 1821,
            title: '큰 사자와 첫 번째 과업',
            episode: 'WEBTOON 39 / 88',
            alt: '메소포타미아의 큰 사자에서 네메아의 사자와 헤라클레스의 첫 과업을 거쳐 레굴루스와 데네볼라가 빛나는 사자자리까지를 점토판 부조풍으로 그린 5단 웹툰'
        },
        Lynx: {
            src: './assets/webtoons/40-lynx-webtoon.webp',
            width: 864,
            height: 1821,
            title: '살쾡이의 눈으로 찾는 별',
            episode: 'WEBTOON 40 / 88',
            alt: '큰곰과 마차부 사이의 희미한 별을 헤벨리우스가 살쾡이자리로 묶고 날카로운 눈의 이름을 붙이는 과정을 은빛 스크래치보드풍으로 그린 5단 웹툰'
        },
        Triangulum: {
            src: './assets/webtoons/41-triangulum-webtoon.webp',
            width: 866,
            height: 1817,
            title: '고대의 삼각형과 M33',
            episode: 'WEBTOON 41 / 88',
            alt: '고대인이 세 별에서 삼각형을 보고 델토톤이라 부른 뒤 나일강 삼각주와 시칠리아에 연결하고, 프톨레마이오스의 기록을 거쳐 M33 은하까지 이어지는 역사를 흑금색 그리스 도기화풍으로 그린 5단 웹툰'
        },
        Cepheus: {
            src: './assets/webtoons/42-cepheus-webtoon.webp',
            width: 865,
            height: 1818,
            title: '세페우스와 별자리 가족',
            episode: 'WEBTOON 42 / 88',
            alt: '세페우스 왕과 카시오페이아의 자랑, 포세이돈이 보낸 케토스, 안드로메다의 희생과 페르세우스의 구출, 델타 세페이드의 거리 측정까지를 고전 궁정 동판화풍으로 그린 5단 웹툰'
        },
        Centaurus: {
            src: './assets/webtoons/43-centaurus-webtoon.webp',
            width: 853,
            height: 1844,
            title: '무기 없는 남쪽 하늘의 켄타우로스',
            episode: 'WEBTOON 43 / 88',
            alt: '무기 없이 이리자리를 제단으로 가져가는 고대 센타우루스의 모습, 여러 전승의 정체, 세차운동과 알파 센타우리·오메가 센타우리까지를 흑금색 고대 성도풍으로 그린 5단 웹툰'
        },
        Horologium: {
            src: './assets/webtoons/44-horologium-webtoon.webp',
            width: 864,
            height: 1820,
            title: '남쪽 하늘을 재는 진자시계',
            episode: 'WEBTOON 44 / 88',
            alt: '라카유가 희망봉에서 남천을 관측하고 진자시계를 새 별자리로 올린 뒤 긴 이름이 시계자리로 줄어든 역사를 푸른 18세기 과학 동판화풍으로 그린 5단 웹툰'
        },
        Gemini: {
            src: './assets/webtoons/45-gemini-webtoon.webp',
            width: 864,
            height: 1821,
            title: '죽음도 갈라놓지 못한 쌍둥이',
            episode: 'WEBTOON 45 / 88',
            alt: '필멸의 카스토르와 불멸의 폴리데우케스가 함께 자라고 죽음으로 갈린 뒤 불멸을 나누어 하늘의 쌍둥이가 되는 전승을 고대 영웅 서사화풍으로 그린 5단 웹툰'
        },
        Andromeda: {
            src: './assets/webtoons/46-andromeda-webtoon.webp',
            width: 865,
            height: 1819,
            title: '바다 괴물에게서 구해진 공주',
            episode: 'WEBTOON 46 / 88',
            alt: '카시오페이아의 자랑으로 케토스가 나타나고 안드로메다가 바위에 묶였다가 페르세우스에게 구출되어 별자리 가족과 M31로 이어지는 이야기를 고전 동판화풍으로 그린 5단 웹툰'
        },
        Aries: {
            src: './assets/webtoons/47-aries-webtoon.webp',
            width: 865,
            height: 1819,
            title: '황금양털이 된 구원의 숫양',
            episode: 'WEBTOON 47 / 88',
            alt: '프릭소스와 헬레를 구한 날개 달린 황금 숫양, 헬레의 추락, 콜키스에 맡겨진 황금양털과 이아손 원정의 시작을 고대 황금 부조화풍으로 그린 5단 웹툰'
        },
        Eridanus: {
            src: './assets/webtoons/48-eridanus-webtoon.webp',
            width: 864,
            height: 1820,
            title: '하늘을 흐르는 끝없는 강',
            episode: 'WEBTOON 48 / 88',
            alt: '오리온의 발치에서 흐르는 별의 강과 파에톤의 추락, 나일강·포강 등의 지리적 해석, 빠르게 자전하는 아케르나르까지를 금빛 고전 성도풍으로 그린 5단 웹툰'
        },
        Vulpecula: {
            src: './assets/webtoons/49-vulpecula-webtoon.webp',
            width: 864,
            height: 1821,
            title: '거위에서 여우만 남은 별자리',
            episode: 'WEBTOON 49 / 88',
            alt: '헤벨리우스가 거위를 문 작은 여우를 별자리로 만들고 이름에서 거위가 사라진 뒤, 1764년 발견된 M27 아령성운까지 이어지는 역사를 고전 자연사 동판화풍으로 그린 5단 웹툰'
        },
        Capricornus: {
            src: './assets/webtoons/50-capricornus-webtoon.webp',
            width: 863,
            height: 1822,
            title: '물고기 꼬리를 가진 염소',
            episode: 'WEBTOON 50 / 88',
            alt: '메소포타미아의 바다염소에서 판의 변신 전승과 별도인 아말테이아 이야기, 현대까지 남은 바다염소 형상으로 이어지는 역사를 청금색 고대 부조화풍으로 그린 5단 웹툰'
        },
    Orion: {
            src: './assets/webtoons/51-orion-webtoon.webp',
            width: 864,
            height: 1821,
            title: '겨울 하늘을 걷는 사냥꾼',
            episode: 'WEBTOON 51 / 88',
            alt: '오리온의 세 별 허리띠와 여러 죽음 전승, 반대 계절에 뜨는 전갈자리, 베텔게우스·리겔과 M42 별 탄생지까지를 금박 과슈 성도풍으로 그린 5단 웹툰'
        },
        Monoceros: {
            src: './assets/webtoons/52-monoceros-webtoon.webp',
            width: 864,
            height: 1820,
            title: '빈 별밭에서 태어난 외뿔소',
            episode: 'WEBTOON 52 / 88',
            alt: '오리온과 두 사냥개 사이의 빈 별밭에 플란시우스가 외뿔소를 그리고 장미성운과 별 탄생지로 이어지는 역사를 성도와 장미창풍으로 그린 5단 웹툰'
        },
        Carina: {
            src: './assets/webtoons/53-carina-webtoon.webp',
            width: 864,
            height: 1821,
            title: '아르고호의 뼈대와 남쪽 별빛',
            episode: 'WEBTOON 53 / 88',
            alt: '거대한 아르고호의 용골 구조와 라카유의 세 구역 분류, 밝은 카노푸스와 별이 태어나는 용골성운을 해양 청사진풍으로 그린 5단 웹툰'
        },
        Draco: {
            src: './assets/webtoons/54-draco-webtoon.webp',
            width: 864,
            height: 1820,
            title: '북극을 감싼 황금사과의 용',
            episode: 'WEBTOON 54 / 88',
            alt: '북극을 감싼 용과 황금사과를 지킨 라돈, 헤라클레스의 과업, 옛 북극성 투반과 고양이눈성운을 옻칠 금박풍으로 그린 5단 웹툰'
        },
        Sextans: {
            src: './assets/webtoons/55-sextans-webtoon.webp',
            width: 864,
            height: 1821,
            title: '불길에서 하늘로 오른 육분의',
            episode: 'WEBTOON 55 / 88',
            alt: '헤벨리우스의 대형 육분의 관측과 1679년 화재, 우라니아의 육분의 별자리와 스핀들은하까지를 구리 동판화풍으로 그린 5단 웹툰'
        },
        Lupus: {
            src: './assets/webtoons/56-lupus-webtoon.webp',
            width: 864,
            height: 1820,
            title: '짐승에서 이리가 된 별',
            episode: 'WEBTOON 56 / 88',
            alt: '센타우루스가 제단으로 내미는 정체 없는 고대 짐승이 라틴 성도에서 이리로 굳고 SN 1006 잔해로 이어지는 역사를 필사본풍으로 그린 5단 웹툰'
        },
        Indus: {
            src: './assets/webtoons/57-indus-webtoon.webp',
            width: 864,
            height: 1821,
            title: '남쪽 별에 붙은 시대의 이름',
            episode: 'WEBTOON 57 / 88',
            alt: '1590년대 남천 관측과 플란시우스·바이어의 성도를 거쳐 인두스가 만들어지고, 옛 인물 도상을 시대적 시선으로 구분하는 과정을 기록화풍으로 그린 5단 웹툰'
        },
        'Canis Minor': {
            src: './assets/webtoons/58-canis-minor-webtoon.webp',
            width: 864,
            height: 1820,
            title: '시리우스보다 먼저 뜨는 개',
            episode: 'WEBTOON 58 / 88',
            alt: '두 별의 작은개와 시리우스보다 먼저 뜨는 프로키온, 오리온의 개·마이라 전승과 겨울철 대삼각형을 종이 오리기풍으로 그린 5단 웹툰'
        },
        'Ursa Minor': {
            src: './assets/webtoons/59-ursa-minor-webtoon.webp',
            width: 864,
            height: 1821,
            title: '북쪽을 가리키는 작은 곰',
            episode: 'WEBTOON 59 / 88',
            alt: '작은 국자와 페니키아 항해자들의 북쪽 찾기, 여러 곰 전승, 폴라리스와 세차운동을 은실 자수 태피스트리풍으로 그린 5단 웹툰'
        },
        'Leo Minor': {
            src: './assets/webtoons/60-leo-minor-webtoon.webp',
            width: 864,
            height: 1821,
            title: '미정형별에서 태어난 작은 사자',
            episode: 'WEBTOON 60 / 88',
            alt: '큰곰과 사자 사이의 미정형별을 헤벨리우스가 작은사자로 묶고, 고대 신화가 없는 역사와 알파 표시가 없는 프라이키푸아를 바로크 동판화풍으로 그린 5단 웹툰'
        },
        Scorpius: {
            src: './assets/webtoons/61-scorpius-webtoon.webp',
            width: 864,
            height: 1820,
            title: '전갈과 사냥꾼이 엇갈리는 계절',
            episode: 'WEBTOON 61 / 88',
            alt: '여름 남쪽 하늘의 전갈과 여러 오리온 죽음 전승, 반대 계절에 뜨는 두 별자리, 붉은 안타레스와 M6·M7 성단을 흑금색 모자이크풍으로 그린 자막형 5단 웹툰'
        },
        Ara: {
            src: './assets/webtoons/62-ara-webtoon.webp',
            width: 864,
            height: 1820,
            title: '남쪽 하늘에 타오른 고대의 제단',
            episode: 'WEBTOON 62 / 88',
            alt: '전갈 아래의 고대 제단과 아라토스의 남천 기록, 신들의 맹세 전승, 은하수와 구상성단 NGC 6397을 석재 부조풍으로 그린 자막형 5단 웹툰'
        },
        Sculptor: {
            src: './assets/webtoons/63-sculptor-webtoon.webp',
            width: 864,
            height: 1820,
            title: '도구가 별자리가 된 조각가의 작업실',
            episode: 'WEBTOON 63 / 88',
            alt: '라카유의 희망봉 관측과 조각가의 작업실 도구, 이름의 간소화, 별 생성이 활발한 NGC 253을 석고와 목탄 작업실풍으로 그린 자막형 5단 웹툰'
        },
        Caelum: {
            src: './assets/webtoons/64-caelum-webtoon.webp',
            width: 864,
            height: 1820,
            title: '별을 새긴 작은 조각칼',
            episode: 'WEBTOON 64 / 88',
            alt: '라카유가 남천에 조각칼을 배치하고 뷔랭과 조각가의 끌이라는 이름이 짧은 Caelum으로 변한 역사와 희미한 알파별을 동판화풍으로 그린 자막형 5단 웹툰'
        },
        Equuleus: {
            src: './assets/webtoons/65-equuleus-webtoon.webp',
            width: 864,
            height: 1820,
            title: '페가수스 곁의 작은 말',
            episode: 'WEBTOON 65 / 88',
            alt: '페가수스 곁의 작은 말머리와 두 번째로 작은 별자리의 크기, 서로 다른 말 전승, 키탈파를 금박 세밀화풍으로 그린 자막형 5단 웹툰'
        },
        Norma: {
            src: './assets/webtoons/66-norma-webtoon.webp',
            width: 864,
            height: 1820,
            title: '알파와 베타가 없는 직각자',
            episode: 'WEBTOON 66 / 88',
            alt: '라카유의 자와 직각자, 경계 변경으로 사라진 알파·베타별, 은하수 별밭과 세페이드 변광성이 있는 NGC 6087을 청사진풍으로 그린 자막형 5단 웹툰'
        },
        Libra: {
            src: './assets/webtoons/67-libra-webtoon.webp',
            width: 864,
            height: 1820,
            title: '집게발에서 독립한 천칭',
            episode: 'WEBTOON 67 / 88',
            alt: '메소포타미아의 저울과 집게, 그리스의 전갈 집게발, 로마의 독립된 천칭과 집게 뜻이 남은 별 이름을 고대 유물 콜라주풍으로 그린 자막형 5단 웹툰'
        },
        Virgo: {
            src: './assets/webtoons/68-virgo-webtoon.webp',
            width: 864,
            height: 1820,
            title: '이삭을 든 봄 하늘의 여신',
            episode: 'WEBTOON 68 / 88',
            alt: '가장 큰 황도 별자리와 여러 여신 해석, 이삭 끝의 스피카, 처녀자리 은하단과 M87 블랙홀을 밀 이삭 필사본풍으로 그린 자막형 5단 웹툰'
        },
        Chamaeleon: {
            src: './assets/webtoons/69-chamaeleon-webtoon.webp',
            width: 864,
            height: 1820,
            title: '남극 가까이 숨은 카멜레온',
            episode: 'WEBTOON 69 / 88',
            alt: '16세기 남천 항해 관측과 1598년 천구의, 근대 성도에 자리 잡은 카멜레온, 남극의 희미한 별과 카멜레온 I 별 탄생지를 자연사 수채화풍으로 그린 자막형 5단 웹툰'
        },
        Cassiopeia: {
            src: './assets/webtoons/70-cassiopeia-webtoon.webp',
            width: 864,
            height: 1820,
            title: 'W자 왕비와 두 번의 별 폭발',
            episode: 'WEBTOON 70 / 88',
            alt: '한국의 북쪽 하늘에 뜬 W자와 카시오페이아 왕비의 자랑·처벌 전승, 1572년의 새 별과 별도인 카시오페이아 A 잔해를 금빛 동판화풍으로 그린 자막형 5단 웹툰'
        },
        Circinus: {
            src: './assets/webtoons/71-circinus-webtoon.webp',
            width: 864,
            height: 1820,
            title: '별과 원을 잇는 남쪽 컴퍼스',
            episode: 'WEBTOON 71 / 88',
            alt: '라카유의 남천 측량과 제도용 컴퍼스, 세 별의 삼각형, 남쪽 은하수와 컴퍼스은하를 밝은 과학 수채화풍으로 그린 자막형 5단 웹툰'
        },
        Crater: {
            src: './assets/webtoons/72-crater-webtoon.webp',
            width: 864,
            height: 1820,
            title: '물뱀의 등 위에 놓인 고대의 잔',
            episode: 'WEBTOON 72 / 88',
            alt: '고대 혼합용 그릇 크라테르와 물뱀 위의 컵, 무화과를 기다린 까마귀 전승과 NGC 3511을 밝은 테라코타 프레스코풍으로 그린 자막형 5단 웹툰'
        },
        'Canis Major': {
            src: './assets/webtoons/73-canis-major-webtoon.webp',
            width: 864,
            height: 1820,
            title: '시리우스를 품은 큰 사냥개',
            episode: 'WEBTOON 73 / 88',
            alt: '큰개자리의 여러 개 전승과 오리온 허리띠에서 시리우스를 찾는 길, 시리우스 쌍성과 M41을 밝은 겨울 모자이크풍으로 그린 자막형 5단 웹툰'
        },
        'Ursa Major': {
            src: './assets/webtoons/74-ursa-major-webtoon.webp',
            width: 864,
            height: 1820,
            title: '북두칠성을 품은 거대한 곰',
            episode: 'WEBTOON 74 / 88',
            alt: '칼리스토 전승과 큰곰자리 일부인 북두칠성, 북극성을 찾는 두 별, 미자르·알코르와 M81·M82를 밝은 천문 태피스트리풍으로 그린 자막형 5단 웹툰'
        },
        Tucana: {
            src: './assets/webtoons/75-tucana-webtoon.webp',
            width: 864,
            height: 1820,
            title: '남쪽 하늘의 큰부리새와 두 별무리',
            episode: 'WEBTOON 75 / 88',
            alt: '남천 항해 기록과 근대 성도의 큰부리새, 소마젤란은하와 앞쪽의 47 투카나에를 밝은 해양 자연사 수채화풍으로 그린 자막형 5단 웹툰'
        },
        Mensa: {
            src: './assets/webtoons/76-mensa-webtoon.webp',
            width: 864,
            height: 1820,
            title: '구름 덮인 산이 된 별자리',
            episode: 'WEBTOON 76 / 88',
            alt: '라카유의 케이프 관측과 흰 구름이 걸린 테이블산, 희미한 별무늬와 파이 멘사이 c를 밝은 케이프 풍경화풍으로 그린 자막형 5단 웹툰'
        },
        Lepus: {
            src: './assets/webtoons/77-lepus-webtoon.webp',
            width: 864,
            height: 1820,
            title: '오리온 발밑을 달리는 토끼',
            episode: 'WEBTOON 77 / 88',
            alt: '아라토스의 고대 성도와 시리우스에게 쫓기는 산토끼, 서로 다른 토끼 전승과 M79를 밝은 겨울 파피루스풍으로 그린 자막형 5단 웹툰'
        },
        Musca: {
            src: './assets/webtoons/78-musca-webtoon.webp',
            width: 864,
            height: 1820,
            title: '벌과 파리 사이를 날아온 이름',
            episode: 'WEBTOON 78 / 88',
            alt: '남천 항해 기록과 벌에서 파리로 바뀐 이름, 석탄자루성운의 먼지와 NGC 5189를 밝은 곤충 자연사 수채화풍으로 그린 자막형 5단 웹툰'
        },
        Octans: {
            src: './assets/webtoons/79-octans-webtoon.webp',
            width: 864,
            height: 1820,
            title: '남쪽 하늘의 극을 품은 항해 도구',
            episode: 'WEBTOON 79 / 88',
            alt: '두 발명가의 반사 팔분의와 항해 측량, 하늘의 남극을 도는 별 궤적과 희미한 시그마 옥탄티스를 밝은 해양 과학화풍으로 그린 자막형 5단 웹툰'
        },
        Pegasus: {
            src: './assets/webtoons/80-pegasus-webtoon.webp',
            width: 864,
            height: 1820,
            title: '별의 큰 사각형을 펼친 날개 말',
            episode: 'WEBTOON 80 / 88',
            alt: '페가수스의 탄생과 벨레로폰의 키마이라 전투, 제우스의 벼락, 안드로메다의 별을 나누는 큰 사각형과 51 페가수스 b를 밝은 고전 프레스코풍으로 그린 자막형 5단 웹툰'
        },
        Perseus: {
            src: './assets/webtoons/81-perseus-webtoon.webp',
            width: 864,
            height: 1820,
            title: '메두사를 든 영웅과 깜빡이는 알골',
            episode: 'WEBTOON 81 / 88',
            alt: '메두사의 머리를 든 페르세우스와 안드로메다 구출, 서로를 가리는 알골의 두 별, 페르세우스 유성우와 이중성단을 중간 명도의 자막형 5단 웹툰으로 그린 이미지'
        },
        Hercules: {
            src: './assets/webtoons/82-hercules-webtoon.webp',
            width: 864,
            height: 1820,
            title: '무릎 꿇은 영웅과 M13의 별무리',
            episode: 'WEBTOON 82 / 88',
            alt: '이름 없는 무릎 꿇은 사람에서 헤라클레스로 이어진 전승, 네 별의 쐐기돌, 구상성단 M13과 아레시보 메시지를 중간 명도의 자막형 5단 웹툰으로 그린 이미지'
        },
        Microscopium: {
            src: './assets/webtoons/83-microscopium-webtoon.webp',
            width: 864,
            height: 1820,
            title: '현미경이 된 별자리와 젊은 행성계',
            episode: 'WEBTOON 83 / 88',
            alt: '초기 현미경과 라카유의 희망봉 남천 측량, 희미한 별자리, 먼지원반과 네 행성을 품은 AU Mic을 중간 명도의 자막형 5단 웹툰으로 그린 이미지'
        },
        Pictor: {
            src: './assets/webtoons/84-pictor-webtoon.webp',
            width: 864,
            height: 1820,
            title: '이젤과 팔레트에서 세 행성까지',
            episode: 'WEBTOON 84 / 88',
            alt: '라카유의 남천 관측과 사람이 아닌 이젤·팔레트, 베타 픽토리스 먼지원반과 2026년 확인된 세 번째 행성을 포함한 세 거대행성을 중간 명도의 자막형 5단 웹툰으로 그린 이미지'
        },
        Fornax: {
            src: './assets/webtoons/85-fornax-webtoon.webp',
            width: 864,
            height: 1820,
            title: '화학의 화로에서 우주의 심층까지',
            episode: 'WEBTOON 85 / 88',
            alt: '라카유의 남천 측량과 화학 실험용 화로, 희미한 별무늬, 포낙스 은하단과 허블 울트라 딥 필드를 중간 명도의 자막형 5단 웹툰으로 그린 이미지'
        },
        Sagitta: {
            src: './assets/webtoons/86-sagitta-webtoon.webp',
            width: 864,
            height: 1820,
            title: '활 없이 날아온 작은 별의 화살',
            episode: 'WEBTOON 86 / 88',
            alt: '활 없이 그려진 고대 화살과 프로메테우스를 구한 헤라클레스 전승, 작은 별무늬와 M71, 대기와 상호작용해 빛나는 유성을 중간 명도의 자막형 5단 웹툰으로 그린 이미지'
        },
        Dorado: {
            src: './assets/webtoons/87-dorado-webtoon.webp',
            width: 864,
            height: 1820,
            title: '마히마히 곁에 펼쳐진 이웃 은하',
            episode: 'WEBTOON 87 / 88',
            alt: '남천을 측량한 항해자와 만새기인 도라도의 형상, 큰마젤란운과 30 도라두스의 별 탄생, SN 1987A를 중간 명도의 자막형 5단 웹툰으로 그린 이미지'
        },
        Taurus: {
            src: './assets/webtoons/88-taurus-webtoon.webp',
            width: 864,
            height: 1820,
            title: '붉은 눈 너머 별무리와 폭발의 흔적',
            episode: 'WEBTOON 88 / 88',
            alt: '황도 위의 고대 황소와 제우스·에우로페 전승, 히아데스 앞쪽의 알데바란, 플레이아데스와 1054년 초신성 잔해인 게성운을 중간 명도의 자막형 5단 웹툰으로 그린 이미지'
        }
    };
