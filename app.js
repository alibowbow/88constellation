...
(function () {
    ...
    const STORY_DETAILS = {
        ...
        Apus: [
            '극락조자리(Apus)는 고대 신화가 아니라 대항해시대의 남천 관측에서 태어난 별자리입니다. 네덜란드 항해자 피터르 케이서와 프레데릭 더하우트만이 동인도 항로에서 기록한 남쪽 별들을 바탕으로 지도 제작자 페트뤼스 플란시우스가 구성했습니다. 1598년 플란시우스와 요도쿠스 혼디우스의 천구의에 나타났고, 요한 바이어가 1603년 《우라노메트리아》에 실으면서 널리 알려졌습니다.',
