...
(function () {
    ...
    const STORY_DETAILS = {
        ...
        Pavo: [
            '공작새자리(Pavo)는 고대 그리스의 48개 별자리가 아니라 대항해시대에 만들어진 남천 별자리입니다. 네덜란드 항해자 피터르 케이서와 프레데릭 더하우트만이 동인도 항로에서 기록한 남쪽 별들을 바탕으로 페트뤼스 플란시우스가 구성했으며, 1598년 천구의에 처음 나타났습니다. 요한 바이어가 1603년 《우라노메트리아》에 그려 넣으면서 널리 알려졌습니다.',
    ...
    const STORY_WEBTOONS = {
        ...
        Cetus: {
            ...
            caption: '카시오페이아의 자만에서 페르세우스와 케토스의 대결까지를 다크 판타지 수묵화풍으로 재구성했습니다.',
        ...
        Puppis: {
            ...
            caption: '황금양털을 찾아 나선 아르고호와 거대한 배 별자리가 세 별자리로 나뉜 과정을 항해 모험물로 재구성했습니다.',
        ...
        Antlia: {
            ...
            caption: '진공 실험의 공기펌프가 라카유의 남천 관측을 거쳐 별자리가 된 과정을 과학 판화풍으로 그렸습니다.',
        ...
        Pavo: {
            ...
            caption: '이오를 지키던 백안의 아르고스와 헤라의 공작 깃털 전승을 보석색 궁정 신화극으로 그렸습니다.',
        ...
        Sagittarius: {
            ...
            caption: '활과 박자에 뛰어났던 뮤즈들의 친구 크로토스가 궁수자리로 남는 이야기를 역동적인 고대 벽화풍으로 그렸습니다.',
        ...
        Reticulum: {
            ...
            caption: '망원경의 마름모형 레티클로 남천 별의 위치를 재고 지도를 만든 과정을 관측 일지풍으로 그렸습니다.',
            ...
            <details class="story-webtoon">
                ...
                <div class="story-webtoon-body">
                    ...
                    <figure>
                        ...
                        <figcaption>${escapeHTML(webtoon.caption || constellation.story || '')}</figcaption>
                    </figure>
                </div>
            </details>
        ` : '';
